        ...
        <table align="center" cellpadding="0" cellspacing="0" class="table_nr">
            ...
            <tr runat="server" id="trTJ">
                <td>
                    <table>
                        <tr>
                            <td align="left" >
                                <asp:TextBox ID="txtSPXMC" runat="server" class="tj_input" Width="696px" onKeyUp="textCounter(this,'divBZ',30)"></asp:TextBox>
                            </td>
            ...
            <tr runat="server" id="trCK">
                <td style="padding-left: 30px; word-break:break-all;word-wrap:break-word" align="left" height="30px">
                    <asp:Label ID="lblCK" runat="server" Text="" style="word-break:break-all ;word-wrap:break-word "></asp:Label>
                </td>
            </tr>
        </table>
    </div>
