        ...
        <table align="center" cellpadding="0" cellspacing="0" class="table_nr">
                    ...
                    <table cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            <td align="left" valign="bottom">
                                <asp:TextBox ID="txtSPXMC" runat="server" Width="696px" Height="130px" TextMode="MultiLine"
            ...
            <tr runat="server" id="trCK">
                <td style="padding-left: 30px" align="left" height="30px">
                    <div runat="server" id="divCK" style="width: 100%; height: 100px; overflow-y: auto; word-break:break-all; word-wrap:break-word">
                        <span id="spanCK" runat="server" style="line-height: 20px; word-break:break-all; word-wrap:break-word"></span>
                    </div>
                </td>
            </tr>
        </table>
