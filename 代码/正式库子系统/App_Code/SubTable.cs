...
namespace FMOP.STABLE //创建子表
{
    public class SubTable:Controls
    {
        ...
        public string CaptionTable2(string htmlStr, string caption,int twidth)
        {
            StringBuilder tabcode = new StringBuilder();
            if (twidth==0||twidth==null)
            {
                tabcode.Append("<table class=\"TableTitle\" width=\"100%\" cellpadding=\"0\" cellspacing=\"0\">");         
            }
            else
            {
                tabcode.Append("<table class=\"TableTitle\" width=\""+twidth+"px\" cellpadding=\"0\" cellspacing=\"0\">");
            }
            tabcode.Append("<tr height=\"33\"><td align=\"center\">" + caption + "</td></tr>");
            tabcode.Append("</table>");
            htmlStr = setAddressChar("</form>", tabcode.ToString(), htmlStr);
        ...
        public string CaptionTable2(string htmlStr, string caption, string display,int twidth)
        {
            StringBuilder tabcode = new StringBuilder();
            if (twidth == 0||twidth==null)
            {
            ...
            {
               tabcode.Append("<table class=\"TableTitle\" width=\"" + twidth + "px\" cellpadding=\"0\" cellspacing=\"0\" style=\"" + display + "\">");
            }
            tabcode.Append("<tr height=\"33\"><td align=\"center\">" + caption + "</td></tr>");
            tabcode.Append("</table>");
            htmlStr = setAddressChar("</form>", tabcode.ToString(), htmlStr);
