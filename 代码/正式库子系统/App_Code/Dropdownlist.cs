        ...
        public string MakeDropDownList(string htmlStr)
        {
            ...
            if (!Caption.Equals(""))
            {
                ...
                else
                {
                    ...
                    {
                        DropdownlistHtml.Append("\t<span id=\"Caption" + Name + "\" style=\"display:none;\">" + Caption + "</span>\r\n");
                    }
                    else
                    {
            ...
            if (!Caption.Equals(""))
            {
                if (CanNull == true)   //可为空
                {
                    ...
                    {
                        DropdownlistHtml.Append(" style=\"display:none;\"");
                    }
                }
            ...
            if (HasModelButton == true)
            {
                if (SubTable == "")
                {
                    //原算法 DropdownlistHtml.Append("\t<input type=\"button\" name=\"openWin\" value=\"..\" class=\"button\" onclick=\"ShowDialog('MasterWin.aspx?moduleName=" + ModuleName + "&fieldName=" + Name + "','400','300');\"/>\r\n");
                ...
                {
                    //原算法 DropdownlistHtml.Append("\t<input type=\"button\" name=\"openWin\" value=\"..\" class=\"smallbutton\" onclick=\"ShowDialog('ChildWin.aspx?moduleName=" + ModuleName + "&fieldName=" + Name + "&tableName=" + SubTable + "','400','300');\"/>\r\n");
                    //新算法 加入不受干扰的CName liujie 2010-09-27
                    DropdownlistHtml.Append("\t<input type=\"button\" name=\"openWin\" value=\"..\" class=\"smallbutton\" onclick=\"ShowDialog('ChildWin.aspx?moduleName=" + ModuleName + "&fieldName=" + Name + "&CfieldName=" + CName + "&tableName=" + SubTable + "','400','300');\"/>\r\n");
                }
            }
