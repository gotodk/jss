...
namespace FMOP.TagCode
{
    public class HtmlFile
    {
        ...
        public string HtmlCode(string Type)
        {
            ...
            htmStruct.Append("<script src=\"../js/jquery.js\" type=\"text/javaScript\"></script>\r\n" );
            ...
            if (AddOnJsFile != "")
            {
                string[] jsstr = AddOnJsFile.Split(',');
                for (int i = 0; i < jsstr.Length; i++)
                {
                    htmStruct.Append("<script src=\"../js/" + jsstr[i] + "\" type=\"text/javaScript\"></script>\r\n");
                }
            }
            ...
            htmStruct.Append("<!--\r\n");
            htmStruct.Append("function kongshijian11(){var k='';}\r\n");
            ...
            htmStruct.Append("\t\t}\r\n");
            htmStruct.Append("\t}\r\n");
            htmStruct.Append("document.getElementById('btnSubmit').onclick = kongshijian11; return this.frm1.onsubmit;\r\n");
