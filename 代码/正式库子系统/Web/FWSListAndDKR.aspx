<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FWSListAndDKR.aspx.cs" Inherits="Web_FWSListAndDKR" %>
...
<body>
    ...
    <script type="text/javascript">
        function setValue(fwsbh,khmc) {
            if (parent.opener.document.getElementById("ZRFKHBH") != null) {
                parent.opener.document.getElementById("ZRFKHBH").value = fwsbh;
            }
            if (parent.opener.document.getElementById("ZRFKHMC") != null) {
                parent.opener.document.getElementById("ZRFKHMC").value = khmc;
            }
