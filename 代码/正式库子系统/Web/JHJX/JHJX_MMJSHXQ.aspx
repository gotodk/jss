<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JHJX_MMJSHXQ.aspx.cs" Inherits="Web_JHJX_JHJX_MMJSHXQ" %>
...
<body>
    ...
    <radTS:RadTabStrip ID="RadTabStrip1" runat="server" Height="25px" Skin="Default2006"
        BackColor="#f7f7f7">
        <Tabs>
            <radTS:Tab ID="Tab1" runat="server" Text="分公司审核买家、卖家功能">
            </radTS:Tab>
        </Tabs>
    </radTS:RadTabStrip>
    <div id="new_content">
            ...
            <div id="content_zw">
                ...
                <div class="content_nr">
                    ...
                    <tr>
                            ...
                            <td colspan="3">
                                <asp:TextBox ID="txtZCJS" runat="server" CssClass="tj_input" Width="200px" Enabled="false"
                        ...
                        <tr id="trKHXKZ" runat="server">
                         ...
                         <tr id="trQTZZ" runat="server">
                            <td align="right">
                                其他资质：
                            </td>
                            <td colspan="3">
                              <asp:TextBox ID="txtQTZZ" runat="server" CssClass="tj_input" Width="200px" Enabled="false"
                                    TabIndex="1"></asp:TextBox> &nbsp;&nbsp;<a id="linkQTZZ" class="link" runat="server" href="" target="_blank">查看</a>
                            </td>
                        </tr>
                        <tr style=" height:110px;">
                            ...
                            <td colspan="3">
                             <asp:TextBox ID="txtJJRSHYJ" runat="server" class="tj_input" Width="400px" Height="100px"
                                    TextMode="MultiLine" MaxLength="200" Text="" Enabled="false"></asp:TextBox>
                            </td>
                        </tr>
                        <tr style=" height:110px;">
                            <td align="right">
                            ...
                            <td colspan="3">
                             <asp:TextBox ID="txtSHYJ" runat="server" class="tj_input" Width="400px" Height="100px"
                                    TextMode="MultiLine" MaxLength="200" Text="" onkeyup="OnkeyUp(this)"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                          <td align="right">
