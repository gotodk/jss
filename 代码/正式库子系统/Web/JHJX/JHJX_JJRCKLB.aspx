<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JHJX_JJRCKLB.aspx.cs" Inherits="Web_JHJX_JHJX_JJRCKLB" %>
...
<body style="background-color: #f7f7f7;">
    ...
    <radTS:RadTabStrip ID="RadTabStrip1" runat="server" Height="25px" Skin="Default2006"
        BackColor="#F7F7F7">
        <Tabs>
            <radTS:Tab ID="Tab1" runat="server" NavigateUrl="JHJX_JJRCKLB.aspx" ForeColor="red"
                Text="经纪人查看列表">
            </radTS:Tab>
        </Tabs>
    </radTS:RadTabStrip>
                                           ...
                                           >
                                            <ItemTemplate>
                                                <tr class="TbodyTr">
                                                    ...
                                                    <td>
                                                        <asp:LinkButton ID="linkSee" runat="server" CommandName="linkSee" CommandArgument='<%#Eval("JSBH")%>'>查看详情</asp:LinkButton>
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
                                        </asp:Repeater>
