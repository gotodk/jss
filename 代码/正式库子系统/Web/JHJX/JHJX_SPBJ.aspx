<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JHJX_SPBJ.aspx.cs" Inherits="Web_JHJX_JHJX_SPBJ" %>
...
<body style=" background-color:#f7f7f7;">
    ...
    <form id="form1" runat="server">
        ...
        <radTS:RadTabStrip ID="TabStrip1" runat="server" CausesValidation="False" ReorderTabRows="True"
                ...
                <Tabs>
                    <radTS:Tab ID="Tab1" runat="server" NavigateUrl="tijiaolei.aspx" Text="信息修改"
