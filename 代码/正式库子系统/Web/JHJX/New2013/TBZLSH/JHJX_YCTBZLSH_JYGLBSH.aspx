<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JHJX_YCTBZLSH_JYGLBSH.aspx.cs" Inherits="Web_JHJX_New2013_TBZLSH_JHJX_YCTBZLSH_JYGLBSH" %>
...
<body style="background-color: #f7f7f7;">
    ...
    <radTS:RadTabStrip ID="RadTabStrip1" runat="server" Height="25px" Skin="Default2006"
        BackColor="#F7F7F7">
        <Tabs>
            <radTS:Tab ID="Tab1" runat="server" ForeColor="Red"  NavigateUrl="JHJX_YCTBZLSH_JYGLBSH.aspx" 
                Text="异常投标资料审核">
            </radTS:Tab>
        </Tabs>
    </radTS:RadTabStrip>
