<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JHJX_MJTBZLSH_YSH.aspx.cs" Inherits="Web_JHJX_New2013_TBZLSH_JHJX_MJTBZLSH_YSH" %>
...
<body style="background-color: #f7f7f7;">
    ...
    <radTS:RadTabStrip ID="RadTabStrip1" runat="server" Height="25px" Skin="Default2006"
        BackColor="#F7F7F7">
        <Tabs>
            <radTS:Tab ID="Tab1" runat="server"  NavigateUrl="JHJX_MJTBZLSH_WSH.aspx" 
                Text="未审核">
            </radTS:Tab>
                 <radTS:Tab ID="Tab2" runat="server" ForeColor="Red" NavigateUrl="JHJX_MJTBZLSH_YSH.aspx"
                Text="已审核"> </radTS:Tab>
        </Tabs>
    </radTS:RadTabStrip>
    <div id="new_content">
                        ...
                        <tr>
                            ...
                            <td  colspan="10">
                                ...
                                <asp:TextBox class="tj_input Wdate" onclick="WdatePicker({readOnly:true,minDate:'2012-01-01',maxDate:'2022-01-01',dateFmt:'yyyy-MM-dd'});"
                                    ID="txtTBStart" runat="server" Width="130px"></asp:TextBox>
                            </td>
                           ...
                           <tr>
                            ...
                            <td align="left" width="130px">
                                 <asp:DropDownList ID="ddlSHZT" runat="server" Height="25px" Width="130px" CssClass="tj_input">
                                         <asp:ListItem Text="全部" Value="">全部</asp:ListItem>
                                      <asp:ListItem Text="审核正常" Value="审核正常">审核正常</asp:ListItem>
                                        <asp:ListItem Text="审核异常" Value="审核异常">审核异常</asp:ListItem>
                                </asp:DropDownList>
                            </td>
                            <td  align="right" width="80px">
                               合同期限：
                            ...
                            <td Width="130px">
                              <asp:DropDownList ID="ddHTQX" runat="server" Height="25px" Width="130px" CssClass="tj_input">
                                         <asp:ListItem Text="全部" Value="">全部</asp:ListItem>
                            ...
                            <td  valign="middle" style="width:121px;" >
                                                ...
                                                <tr class="TbodyTr">
                                                    ...
                                                    <td style=" width:100px;word-wrap:break-word; ">
                                                     ...
                                                     <td style=" width:120px;word-wrap:break-word; ">
                                                          <div style=" width:120px;word-wrap:break-word; line-height:18px;">  <%#Eval("服务中心审核时间")%></div>
                                                    </td>
                                                        <td style=" width:120px;word-wrap:break-word; ">
                                                          <div style=" width:120px;word-wrap:break-word; line-height:18px;">  <%#Eval("服务中心审核状态")%></div>
                                                    </td>
                                                      <td style=" width:180px;word-wrap:break-word; ">
                                                          <div style=" width:180px; text-align:center; word-wrap:break-word; line-height:18px;">  <%#Eval("上次审核未通过后是否修改")%></div>
                                                    </td>
                                                          <td style=" width:120px;word-wrap:break-word; ">
                                                          <div style=" width:120px;word-wrap:break-word; line-height:18px;">  <%#Eval("卖家修改时间")%></div>
                                                    </td>
                                                        <td style=" width:140px;word-wrap:break-word; ">
                                                          <div style=" width:140px;word-wrap:break-word; line-height:18px;">  <%#Eval("交易管理部审核状态")%></div>
                                                    </td>
                                                        <td style=" width:140px;word-wrap:break-word; ">
                                                          <div style=" width:140px;word-wrap:break-word; line-height:18px;">  <%#Eval("交易管理部审核时间")%></div>
                                                    </td>
