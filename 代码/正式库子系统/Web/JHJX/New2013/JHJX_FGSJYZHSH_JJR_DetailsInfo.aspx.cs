...
public partial class Web_JHJX_New2013_JHJX_FGSJYZHSH_JJR_DetailsInfo : System.Web.UI.Page
{
    ...
    protected void BindData()
    {
        ...
        if (dataTable.Rows.Count > 0)
        {
            ...
            this.txtCS_JL.Text = dataTable.Rows[0]["FGSSHZT"].ToString();
            this.txtCS_SJ.Text = dataTable.Rows[0]["FGSSHSJ"].ToString();
    ...
    {
        Response.Redirect("JHJX_FGSJYYHCK_JJR.aspx");
    }
}