<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JHJX_FGSJYZHSH_MMJ_Details.aspx.cs" Inherits="Web_JHJX_New2013_JHJX_FGSJYZHSH_MMJ_Details" %>
            ...
            <div id="content_zw">
                ...
                <div class="content_nr">
                    ...
                    <tr  id="trJYZHLX" runat="server">
                            ...
                            <td colspan="3">
                                    <asp:RadioButton ID="radJJR" runat="server"  GroupName="ZHLX" Text="经纪人交易账户" Enabled="false" />&nbsp;&nbsp;<asp:RadioButton
                                    ID="radMMJ" runat="server" Text="交易方交易账户" Enabled="false" GroupName="ZHLX" />&nbsp;&nbsp;</td>
                        </tr>
                        ...
                        <tr id="trFS_YJ" runat="server" style=" height:110px;">
                            ...
                            <td colspan="3">
                             <asp:TextBox ID="txtFS_YJ" runat="server" class="tj_input" Width="400px" Height="100px"
                            ...
                            <div id="djycqymain" style=" margin-top:10px;">
                              <div id="djycqy_show">
                                <asp:Button ID="btnPass" runat="server" CssClass="tj_bt_da" UseSubmitBehavior="False"
                                    Text="通过" Width="50px"  onclick="btnPass_Click" />&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="btnReject"
