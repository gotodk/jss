<%@ Page Language="C#" AutoEventWireup="true" CodeFile="jhjx_spmmljq.aspx.cs" Inherits="Web_JHJX_New2013_JHJX_SPMM_jhjx_spmmljq" %>
    ...
    <form id="form1" runat="server">
        <radTS:RadTabStrip ID="RadTabStrip1" runat="server" Height="25px" Skin="Default2006"
            ...
            <Tabs>
                ...
                <radTS:Tab ID="Tab3" runat="server" NavigateUrl="jhjx_spmmljq.aspx" ForeColor="red"
                    Text="冷静期">
                </radTS:Tab>
                            ...
                            <tr>
                                <td>
                                    <div style="overflow-x: scroll;">
                                        <table id="theObjTable" style="width: 1940px;" cellspacing="0" cellpadding="0">
                                            <thead>
                                                <tr>
