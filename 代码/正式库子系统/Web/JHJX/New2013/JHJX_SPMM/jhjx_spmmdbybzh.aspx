<%@ Page Language="C#" AutoEventWireup="true" CodeFile="jhjx_spmmdbybzh.aspx.cs" Inherits="Web_JHJX_New2013_JHJX_SPMM_jhjx_spmmdbybzh" %>
    ...
    <form id="form1" runat="server">
        <radTS:RadTabStrip ID="TabStrip1" runat="server" CausesValidation="False" ReorderTabRows="True"
            ...
            <Tabs>
                ...
                <radTS:Tab ID="Tab6" runat="server" NavigateUrl="jhjx_spmmdbybzh.aspx" ForeColor="Red"
                    Text="定标与保证函">
                </radTS:Tab>
                    ...
                    <div class="content_nr">
                        <table width="100%" cellpadding="0" cellspacing="0" class="content_nr_cx" style="border: solid 1px #ccc">
                            ...
                            <td width="70px" align="left">
                              <asp:DropDownList ID="ddlssfgs" runat="server" CssClass="tj_input" Width="100px" 
                                    >
                                    </asp:DropDownList>
                            </td>
                            ...
                            <tr>
                                <td>
                                    <div style="overflow-x: scroll;">
                                        <table id="theObjTable" style="width: 2260px;" cellspacing="0" cellpadding="0">
                                            <thead>
                                                <tr>
                                                    <th class="TheadTh" style="width: 100px;">查看详情
                                                    </th>
                                                    <th class="TheadTh" style="width: 100px;">查看保证函
                                                    </th>
                                                    ...
                                                    <th class="TheadTh" style="width: 80px;">合同编号
                                                    </th>
                                                    <th class="TheadTh" style="width: 150px;">定标时间
                                                    </th>
                                                    ...
                                                    <th class="TheadTh" style="width: 100px;">定标数量
                                                    </th>
                                                    <th class="TheadTh" style="width: 100px;">定标价格
                                                    </th>
                                                    <th class="TheadTh" style="width: 100px;">定标金额
                                                    </th>
                                                    <th class="TheadTh" style="width: 100px; line-height: 18px;">投标保证金<br />
                                                        解冻金额
                                                    </th>
                                                    <th class="TheadTh" style="width: 100px;">订金冻结金额
                                                    </th>
                                                    <th class="TheadTh" style="width: 100px; line-height: 18px;">履约保证金<br />
                                                        冻结金额
                                                    </th>
                                                    <th class="TheadTh" style="width: 100px;">违约扣罚记录
                                                    </th>
                                                    <th class="TheadTh" style="width: 100px; line-height: 18px;">履约保证金<br />
                                                        冻结剩余比例
                                                    </th>
                                                    ...
                                                    <%--  <th class="TheadTh" style="width: 100px;">中标定标号
                                                    </th>--%>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <asp:Repeater ID="rptSPXX" runat="server" OnItemCommand="rptSPXX_ItemCommand">
                                                    <ItemTemplate>
                                                        <tr class="TbodyTr">
                                                            <td style="width: 100px;">
                                                                <asp:LinkButton
                                                                    ID="linkSee" runat="server" CommandName="linkSee" CommandArgument='<%#Eval("中标定标编号")%>'>查看详情</asp:LinkButton>
                                                            </td>
                                                            <td style="width: 100px;">
                                                                <asp:LinkButton
                                                                    ID="linkbzh" runat="server" CommandName="linkbzh" CommandArgument='<%#Eval("中标定标编号")%>' Visible='<%#Eval("单据类型").ToString ()=="投标单" %>'>查看保证函</asp:LinkButton>
                                                                <asp:Label ID="lblydd" runat="server" Visible='<%#Eval("单据类型").ToString ()=="预订单" %>'>---</asp:Label>
                                                            </td>
                                                            <td style="width: 100px;">
                                                                <%#Eval("业务管理部门")%>
                                                            </td>
                                                            ...
                                                            <td style="width: 80px;">
                                                                <asp:LinkButton
                                                                    ID="Linkht" runat="server" CommandName="Linkht" CommandArgument='<%#Eval("中标定标编号")%>'><%#Eval("合同编号")%></asp:LinkButton>
                                                            </td>
                                                            <td style="width: 150px;">
                                                                <%#Eval("定标时间")%>
                                                            </td>
                                                            <td title='<%#Eval("下单时间")%>' style="width: 150px;">
                                                                <asp:Label ID="lbspmc" runat="server" Text='<%#Eval("下单时间")%>'> </asp:Label>
                                                            </td>
                                                            <td style="width: 100px;">
                                                                <asp:Label ID="labdjlx" runat="server" Text='<%#Eval("单据类型")%>'> </asp:Label>
                                                            </td>
                                                            <td style="width: 100px;">
                                                                <%#Eval("单据编号")%>
                                                            </td>
                                                            ...
                                                            <td style="width: 100px;">
                                                                <asp:LinkButton
                                                                    ID="linwykf" runat="server" CommandName="linwykf" CommandArgument='<%#Eval("中标定标编号")%>'><%#Eval("违约扣罚记录")%></asp:LinkButton>
                                                            </td>
                                                            <td style="width: 100px;">
                                                                <asp:Label ID="labdjbl" runat="server" Text='<%#Eval("履约保证金冻结剩余比例")%>'> </asp:Label>
                                                            </td>
                                                            <td style="width: 100px;">
                                                                <%#Eval("是否拆单")%>
                                                            </td>
