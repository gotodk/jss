...
public partial class Web_JHJX_New2013_JHJX_JHJX_ZJZZ_JHJX_BCSYFSJL : System.Web.UI.Page
{
    ...
    {
        DataSet ds = DbHelperSQL.Query("select XM, XZ as XZvalue,(case when LEN (XZ)>10 then SUBSTRING (xz,0,11)+'...' else XZ end) as XZtext from AAA_moneyDZB where 1=1  and dymkbh='8' and   sjlx='预' order by dymkbh");
        ViewState["XMXZ"] = ds;
        setXM(ds.Tables[0]);
    ...
    private Hashtable SetV()
    {
        ...
        ht_where["search_str_where"] = " a.sjlx='预' and isnull(b.dymkbh,'')='8' ";  //检索条件  
    ...
    protected void btnToExcel_Click(object sender, EventArgs e)
    {
        ...
        MXC.goxls(NewDS, "Report_" + DateTime.Now.ToString("yyyy-MM-dd:hh-mm-sss") + ".xls", "补偿收益发生记录", "补偿收益发生记录", 15);
    }
}