<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JHJX_JJRSYFSJL.aspx.cs" Inherits="Web_JHJX_New2013_JHJX_JHJX_ZJZZ_JHJX_JJRSYFSJL" %>
...
<body style="background-color: #f7f7f7;">
    ...
    <radTS:RadTabStrip ID="RadTabStrip1" runat="server" Height="25px" Skin="Default2006"
        BackColor="#F7F7F7">
        <Tabs>
           <radTS:Tab ID="Tab1" runat="server" NavigateUrl="JHJX_ZJYEBDMX.aspx" 
                Text="资金余额变动明细">
            </radTS:Tab>
                 <radTS:Tab ID="Tab2" runat="server" NavigateUrl="JHJX_WYPCFSJL.aspx"
                Text="违约赔偿发生记录"> </radTS:Tab>
                         <radTS:Tab ID="Tab3" runat="server" NavigateUrl="JHJX_BCSYFSJL.aspx"  
                Text="补偿收益发生记录"> </radTS:Tab>
                                  <radTS:Tab ID="Tab4" runat="server" NavigateUrl="JHJX_JJRSYFSJL.aspx"  ForeColor="red"
                Text="经纪人收益发生记录">
            </radTS:Tab>
        </Tabs>
    </radTS:RadTabStrip>
                                ...
                                <table id="theObjTable" style="width: 100%;" cellspacing="0" cellpadding="0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="TheadTh" style=" width:280px;word-wrap:break-word; ">
                                                摘要
                                            </th>
                                            <th class="TheadTh" style=" width:120px;word-wrap:break-word; ">
                                                项目
                                            </th>
                                            <th class="TheadTh" style=" width:150px;word-wrap:break-word; ">
                                                性质
                                            </th>
                                            ...
                                            <ItemTemplate>
                                                <tr class="TbodyTr">
                                                    <td style=" width:120px;word-wrap:break-word; ">
                                                      <div style=" width:120px;word-wrap:break-word;">  <%#Eval("变动时间")%></div>
                                                    </td>
                                                    <td style=" width:100px;word-wrap:break-word; ">
                                                      
                                                           <div style=" width:100px;word-wrap:break-word;">  <%#Eval("交易方名称")%></div>
                                                    </td>
                                                    <td style=" width:120px;word-wrap:break-word; ">
                                                 
                                                          <div style=" width:120px;word-wrap:break-word;">  <%#Eval("交易方账号")%></div>
                                                    </td>
                                                    <td style=" width:100px;word-wrap:break-word; ">
                                                  
                                                          <div style=" width:100px;word-wrap:break-word;">  <%#Eval("分公司名称")%></div>
                                                    </td>
                                                    ...
                                                    <td style=" width:120px;word-wrap:break-word; ">
                                                            ...
                                                            <div style=" width:120px;word-wrap:break-word;">  <%#Eval("项目")%></div>
                                                    </td>
                                                    <td  style=" width:150px;word-wrap:break-word; ">
                                                   
                                                           <div style=" width:150px;word-wrap:break-word;">  <%#Eval("性质")%></div>
                                                    </td>
                                                     <td  style=" width:90px;word-wrap:break-word; ">
                                                   
                                                           <div style=" width:90px;word-wrap:break-word;">  <%#Eval("金额")%></div>
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
                                        </asp:Repeater>
