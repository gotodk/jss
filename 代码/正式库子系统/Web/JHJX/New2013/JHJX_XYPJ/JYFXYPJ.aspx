<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JYFXYPJ.aspx.cs" Inherits="Web_JHJX_New2013_JHJX_XYPJ_JYFXYPJ" %>
                ...
                <div class="content_nr">
                    ...
                    <table width="700px" class="Message"  id="tabn" runat="server" visible="false">
                        ...
                        <tbody>
                            ...
                            <asp:TextBox ID="txthtbh" runat="server" Width="150px" CssClass="tj_input" ></asp:TextBox>  
