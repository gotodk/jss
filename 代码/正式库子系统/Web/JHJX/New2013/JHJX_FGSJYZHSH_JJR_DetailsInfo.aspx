<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JHJX_FGSJYZHSH_JJR_DetailsInfo.aspx.cs" Inherits="Web_JHJX_New2013_JHJX_FGSJYZHSH_JJR_DetailsInfo" %>
                    ...
                    <tr  id="trJYZHLX" runat="server">
                        ...
                        <tr id="trLXRSJH" runat="server">
                         ...
                         <tr id="trKHYH" runat="server">
                            ...
                            <td colspan="3">
                              <asp:TextBox ID="txtKHYH" runat="server" CssClass="tj_input" Width="380px" Enabled="false"
                                    TabIndex="1"></asp:TextBox>
                            </td>
                        </tr>
                        ...
                        <tr style=" height:110px;">
                            ...
                            <td colspan="3">
                             <asp:TextBox ID="txtCS_SHYJ" runat="server" class="tj_input" Width="400px" Enabled="false" Height="100px"
