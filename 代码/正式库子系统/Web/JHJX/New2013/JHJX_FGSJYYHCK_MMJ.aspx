<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JHJX_FGSJYYHCK_MMJ.aspx.cs" Inherits="Web_JHJX_New2013_JHJX_FGSJYYHCK_MMJ" %>
...
<%@ Register src="../../UCCityList.ascx" tagname="UCCityList" tagprefix="uc3" %>

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>分公司审核买家卖家资料</title>
...
<body style="background-color: #f7f7f7;">
    <form id="form1" runat="server">
        <radTS:RadTabStrip ID="RadTabStrip1" runat="server" Height="25px" Skin="Default2006"
            BackColor="#F7F7F7">
            <Tabs>
                <radTS:Tab ID="Tab1" runat="server" NavigateUrl="JHJX_FGSJYYHCK_JJR.aspx"
                    Text="经纪人资料查看">
                </radTS:Tab>
                <radTS:Tab ID="Tab2" runat="server" NavigateUrl="JHJX_FGSJYYHCK_MMJ.aspx" ForeColor="red"
                    Text="交易方资料查看">
                </radTS:Tab>
            </Tabs>
        </radTS:RadTabStrip>
                    ...
                    <div class="content_nr">
                        <table width="100%" cellpadding="0" cellspacing="0" class="content_nr_cx" style="border: solid 1px #ccc">
                         ...
                         <td width="70px" align="right">
                            ...
                            <td  style="display:inline;width:380px" colspan="4">
                                <uc3:uccitylist ID="UCCityList1"   runat="server" />                             
                        ...
                        <tr>
                            ...
                            <td width="110px" align="left">
                                    <asp:DropDownList ID="ddlFSJL" runat="server" Width="110px" CssClass="tj_input"
                                        Height="22px">
                            ...
                            <td style="width:80px;text-align:right;">经纪人账号：</td>
                            <td width="110px" align="left">
                                    <asp:TextBox ID="txtJJRZH" runat="server"
                                        class="tj_input" Width="110px"></asp:TextBox>

                            </td>
                             <td style="width:80px;text-align:right;">经纪人名称：</td>
                            <td width="110px" align="left">
                                    <asp:TextBox ID="txtJJRMC" runat="server"
                                        class="tj_input" Width="110px"></asp:TextBox>
                            ...
                            <tr>
                                <td>
                                    <div id="exprot" runat="server" style="width: 1110px;" class="content_nr_lb">
                                        <table id="theObjTable" style="width: 1670px;" cellspacing="0" cellpadding="0">
                                            <thead>
                                                <tr>
                                                    <th class="TheadTh" style="width: 90px; text-align: center;">查看
                                                    </th>
                                                    <th class="TheadTh" style="width: 140px; text-align: center;">交易方账号
                                                    </th>
                                                    <th class="TheadTh" style="width: 120px; text-align: center;">交易方名称
                                                    </th>
                                                    <th class="TheadTh" style="width: 120px; text-align: center;">经纪人资格证书编号
                                                    </th>
                                                    <th class="TheadTh" style="width: 120px; text-align: center;">经纪人名称
                                                    </th>
                                                    <th class="TheadTh" style="width: 120px; text-align: center;">资料提交时间
                                                    </th>
                                                    <th class="TheadTh" style="width: 60px; text-align: center;">注册类型
                                                    </th>
                                                    <th class="TheadTh" style="width: 170px; text-align: center;">所属区域
                                                    </th>
                                                    <th class="TheadTh" style="width: 110px; text-align: center;">平台管理机构
                                                    </th>
                                                    <th class="TheadTh" style="width: 70px; text-align: center;">联系人姓名
                                                    </th>
                                                    <th class="TheadTh" style="width: 100px; text-align: center;">联系电话   
                                                    </th>
                                                    <th class="TheadTh" style="width: 120px; text-align: center;">初审时间
                                                    </th>
                                                    <th class="TheadTh" style="width: 70px; text-align: center;">初审记录
                                                    </th>
                                                    <th class="TheadTh" style="width: 70px; text-align: center;">复审记录
                                                    </th>
                                                    <th class="TheadTh" style="width: 120px; text-align: center;">暂停新业务时间
                                                    </th>
                                                        ...
                                                        <tr class="TbodyTr">
                                                            <td style="width: 90px; word-wrap: break-word;">
                                                                <div style="width: 90px; word-wrap: break-word;">
                                                                    <asp:LinkButton ID="linkJXSH" runat="server" CommandName="linkJXSH" CommandArgument='<%#Eval("Number")%>'>资料详情</asp:LinkButton>
                                                                </div>

                                                            </td>
                                                            <td align="center" style="width: 140px; word-wrap: break-word;">
                                                                <div style="width: 140px; word-wrap: break-word;"><%#Eval("交易方账号")%></div>
                                                            </td>
                                                            <td align="center" style="width: 120px; word-wrap: break-word;">
                                                                <div style="width: 120px; word-wrap: break-word;"><%#Eval("交易方名称")%></div>
                                                            </td>
                                                            <td align="center" style="width: 120px; word-wrap: break-word;">
                                                                <div style="width: 120px; word-wrap: break-word;"><%#Eval("经纪人资格证书编号")%></div>
                                                            </td>
                                                            <td align="center" style="width: 120px; word-wrap: break-word;">
                                                                <div style="width: 120px; word-wrap: break-word;"><%#Eval("经纪人名称")%></div>
                                                            </td>
                                                            <td align="center" style="width: 120px; word-wrap: break-word;">
                                                                <div style="width: 120px; word-wrap: break-word;"><%#Eval("资料提交时间")%></div>
                                                            </td>
                                                            <td align="center" style="width: 60px; word-wrap: break-word;">
                                                                <div style="width: 60px; word-wrap: break-word;"><%#Eval("注册类型")%></div>
                                                            </td>
                                                            <td align="center" style="width: 170px; word-wrap: break-word;">
                                                                <div style="width: 170px; word-wrap: break-word;"><%#Eval("所属区域")%></div>
                                                            </td>
                                                            <td align="center" style="width: 110px; word-wrap: break-word;">
                                                                <div style="width: 110px; word-wrap: break-word;"><%#Eval("平台管理机构")%></div>
                                                            </td>
                                                            <td align="center" style="width: 70px; word-wrap: break-word;">
                                                                <div style="width: 70px; word-wrap: break-word;"><%#Eval("联系人姓名")%></div>
                                                            </td>
                                                            <td align="center" style="width: 100px; word-wrap: break-word;">
                                                                <div style="width: 100px; word-wrap: break-word;"><%#Eval("联系电话")%></div>
                                                            </td>
                                                            <td align="center" style="width: 120px; word-wrap: break-word;">
                                                                <div style="width: 120px; word-wrap: break-word;"><%#Eval("初审时间").ToString()==""?"- -":Eval("初审时间").ToString()%></div>
                                                            </td>
                                                            <td align="center" style="width: 70px; word-wrap: break-word;">
                                                                <div style="width: 70px; word-wrap: break-word;"><%#Eval("初审记录")%></div>
                                                            </td>
                                                            <td align="center" style="width: 70px; word-wrap: break-word;">
                                                                <div style="width: 70px; word-wrap: break-word;"><%#Eval("复审记录")%></div>
                                                            </td>
                                                            <td align="center" style="width: 120px; word-wrap: break-word;">
                                                                <div style="width: 120px; word-wrap: break-word;"><%#Eval("暂停新业务时间").ToString() == "" ? "- -":Eval("暂停新业务时间").ToString()%></div>
                                                            </td>
                                                            <td align="center" style="width: 70px; word-wrap: break-word;">
