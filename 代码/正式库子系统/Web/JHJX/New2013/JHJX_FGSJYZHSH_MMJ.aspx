<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JHJX_FGSJYZHSH_MMJ.aspx.cs" Inherits="Web_JHJX_New2013_JHJX_FGSJYZHSH_MMJ" %>
...
<body style="background-color: #f7f7f7;">
    ...
    <radTS:RadTabStrip ID="RadTabStrip1" runat="server" Height="25px" Skin="Default2006"
        BackColor="#F7F7F7">
        <Tabs>
           <radTS:Tab ID="Tab1" runat="server" NavigateUrl="JHJX_FGSJYZHSH_JJR.aspx"
                Text="审核经纪人资料">
            </radTS:Tab>
               <radTS:Tab ID="Tab2" runat="server" NavigateUrl="JHJX_FGSJYZHSH_MMJ.aspx"  ForeColor="red"
                Text="审核交易方资料">
            </radTS:Tab>
        </Tabs>
    </radTS:RadTabStrip>
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" class="content_nr_cx" style="border: solid 1px #ccc">
                        ...
                        <tr>
                            ...
                            <td width="135px" align="left">
                               <asp:DropDownList ID="ddlFSJL" runat="server" Width="135px" CssClass="tj_input"
                                    Height="22px">
                            ...
                            <td  style="padding-left:10px;" >
                                 <asp:Button ID="btnSearch" runat="server" CssClass="tj_bt" Width="50px" 
                                    Text="查询" onclick="btnSearch_Click"
                                     /></td>
                            <td style="width:220px"><%--经纪人名称：--%>
                                <asp:TextBox ID="txtJJRMC" runat="server" 
                                   
                                    class="tj_input" Width="1px" Visible="false"></asp:TextBox>
                    ...
                    <table width="100%" cellspacing="0" cellpadding="0" border="1" bordercolor="#99BBE8"
                        ...
                        <tr>
                            <td>
                                ...
                                <table id="theObjTable" style="width: 1620px;" cellspacing="0" cellpadding="0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="TheadTh" style="width: 170px;  text-align: center;">
                                                所属区域
                                            </th>                                           
                                            ...
                                            <ItemTemplate>
                                                <tr class="TbodyTr">
                                                   <td style="width:120px;word-wrap:break-word; ">
                                                        <asp:LinkButton ID="linkJXSH" runat="server" CommandName="linkJXSH" CommandArgument='<%#Eval("Number")%>'>进行审核</asp:LinkButton>
                                                  ...
                                                  <td align="center" style="width:110px;word-wrap:break-word; ">
                                                    <div style=" width:110px; word-wrap:break-word;"><asp:Label ID="lbjg" runat="server" Text='<%#Eval("平台管理机构")%>' > </asp:Label> </div>
                                                    </td>
                                                    ...
                                                    <div style=" width:70px; word-wrap:break-word;"><%#Eval("复审记录")%></div>
                                                       ...
                                                       <td align="center" style="width:110px;word-wrap:break-word; ">
                                                    <div style=" width:110px; word-wrap:break-word; "><%#Eval("驳回后是否修改")%></div>
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
                                        </asp:Repeater>
