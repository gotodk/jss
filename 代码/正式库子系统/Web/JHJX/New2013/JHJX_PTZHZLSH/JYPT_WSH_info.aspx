<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JYPT_WSH_info.aspx.cs" Inherits="Web_JHJX_New2013_JHJX_PTZHZLSH_JYPT_WSH_info" %>
            ...
            <div id="new_zicontent">
                <div id="content_zw">
                    ...
                    <div class="content_nr">
                        ...
                        <table width="850px" class="Message" id="Table2" runat="server">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style="text-align: left;" colspan="3">
                                        ...
                                        <asp:TextBox ID="txt_FWZX_SHYJ" runat="server" CssClass="tj_input" Width="541px" Enabled="True"
                                            Height="100px" MaxLength="150" TextMode="MultiLine"></asp:TextBox>
                                    </td>
                                </tr>
                            </tbody>
                            ...
                            <tbody>
                              ...
                              <div id="djycqy_show">
                                                ...
                                                <asp:Button ID="btnPass" runat="server" CssClass="tj_bt_da" Text="审核通过" Height="30"
                                                    Width="80" OnClientClick="return Promot(this)" OnClick="btnPass_Click" UseSubmitBehavior="False" />
                                                    &nbsp;&nbsp;
                                                &nbsp;&nbsp;
                                                   <asp:Button ID="btnJYDJ" runat="server" CssClass="tj_bt_da" Text="建议冻结" Height="30"
                                                       Width="80"  OnClientClick="return Promot(this)" OnClick="btnJYDJ_Click" UseSubmitBehavior="False" />
                                                    &nbsp;&nbsp;
                                                &nbsp;&nbsp;
