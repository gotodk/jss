<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JYPT_SHTG.aspx.cs" Inherits="Web_JHJX_New2013_JHJX_PTZHZLSH_JYPT_SHTG" %>
        ...
        <Tabs>
            <radTS:Tab ID="Tab1" runat="server" NavigateUrl="JYPT_WSH.aspx" 
                Text="未审核">
                 ...
                 <radTS:Tab ID="Tab2" runat="server"  ForeColor="Red"  NavigateUrl="JYPT_SHTG.aspx"
