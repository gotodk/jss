<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JYPT_SHTG_info.aspx.cs" Inherits="Web_JHJX_New2013_JHJX_PTZHZLSH_JYPT_SHTG_info" %>
            ...
            <div id="new_zicontent">
                <div id="content_zw">
                    ...
                    <div class="content_nr">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style="text-align: left; width: 150px">
                                        ...
                                        <asp:Label ID="lbl_FWZXSH_SHR" runat="server"></asp:Label>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: left;" colspan="3">
                                        ...
                                        <asp:TextBox ID="txt_FWZX_SHYJ" runat="server" CssClass="tj_input" Width="541px" Enabled="false"
                                            Height="100px" MaxLength="150" TextMode="MultiLine"></asp:TextBox>
                                    </td>
                                </tr>
                            </tbody>
                        ...
                        <table width="850px" class="Message" id="tabFWZX" runat="server">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style="text-align: left;" colspan="3">
                                        ...
                                        <asp:TextBox ID="txt_FWZXX_SHYJ" runat="server" CssClass="tj_input" Width="541px" Enabled="true"
                                            Height="100px" MaxLength="150" TextMode="MultiLine"></asp:TextBox>
                                    </td>
                                </tr>
                            </tbody>
                        ...
                        <table width="800px" class="Message" id="tab3" runat="server">
                            ...
                            <tbody>
                              ...
                              <div id="djycqy_show">
                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                <asp:Button ID="btnPass" runat="server" CssClass="tj_bt_da" Text="撤销原审核并建议冻结" Height="30"
                                                    Width="150" OnClientClick="return Promot(this)" OnClick="btnPass_Click" UseSubmitBehavior="False" />
                                                &nbsp;&nbsp;   &nbsp;&nbsp;
                                                <asp:Button ID="btnBack" runat="server" CssClass="tj_bt_da" Text="返回列表" Height="30"
                                                    Width="80" OnClick="btnBack_Click" UseSubmitBehavior="False" />
                                  </div></div>
                                                </td>
                                            </tr>
                                        </table>
