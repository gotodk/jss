...
public partial class Web_JHJX_New2013_JHJX_PTZHZLSH_JHJX_JYDJ_info : System.Web.UI.Page
{
    ...
    public void BindDataFace()
    {
        ...
        if (dataTable.Rows.Count > 0)
        {
            ...
            //服务中心审核
            this.lab_FWZXSH_SHR.Text = dataTable.Rows[0]["服务中心审核人"].ToString();
            this.lab_FWZXSH_SHSJ.Text = dataTable.Rows[0]["服务中心审核时间"].ToString();
            this.txtFWZXSH_SHYJ.Text = dataTable.Rows[0]["服务中心审核意见"].ToString();
            //服务中心新审核
            this.lab_FWZXXSH_SHR.Text = dataTable.Rows[0]["服务中心新审核人"].ToString();
            this.lab_FWZXXSH_SHSJ.Text = dataTable.Rows[0]["服务中心新审核时间"].ToString();
            this.txt_FWZXXSH_SHYJ.Text = dataTable.Rows[0]["服务中心新审核意见"].ToString();
            //交易管理部审核
            this.lab_JYGLBSH_SHR.Text = dataTable.Rows[0]["交易管理部审核人"].ToString();
            this.lab_JYGLBSH_SHSJ.Text = dataTable.Rows[0]["交易管理部审核时间"].ToString();
            this.txt_JYGLBSH_SHYJ.Text = dataTable.Rows[0]["交易管部审核意见"].ToString();
    ...
    {
        if (ViewState["Page"] != null && ViewState["Page"].ToString() == "NBDY")
        {
            Response.Redirect("JHJX_JYDJ.aspx");
        }
        else
        {
            Response.Redirect("../JHJX_UserDongJie/jhjx_UserDJ.aspx");
        }
