<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CSSPZLSH_WSH.aspx.cs" Inherits="Web_JHJX_New2013_JHJX_CSSPZLSH_CSSPZLSH_WSH" %>
                                    ...
                                    <table id="theObjTable"  style="width:100%; " cellspacing="0"  cellpadding="0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="TheadTh" style=" width:110px; line-height:18px;">
                                                    是否变更<br />资质或标准</th>    
                                            ...
                                            <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand" 
                                                ...
                                                <ItemTemplate>
                                                    <tr class="TbodyTr">
                                                        ...
                                                        <td style=" width:220px;" title='<%#Eval("交易方名称") %>'>
                                                          <div style=" word-wrap:break-word; line-height:18px;  width:220px;">  <%#Eval("交易方名称").ToString().Length > 14 ? Eval("交易方名称").ToString().Substring(0, 14) + "..." : Eval("交易方名称").ToString()%></div>   
                                                        </td>
                                                          <td>
                                                               <%#Eval("申请时间") %>
                                                        </td>
                                                        ...
                                                        <td>
                                                          <%-- <asp:LinkButton ID="btnCK" runat="server" CommandName='<%#Eval("交易方账号")+"&"+Eval("商品编号") %>' CommandArgument="ck">查看详情</asp:LinkButton> &nbsp;&nbsp;--%>
                                                            <asp:LinkButton ID="LinkButton1" runat="server" CommandName='<%#Eval("Number") %>' CommandArgument="sh">审核</asp:LinkButton> 
                                                        </td>
                                                    </tr>
                                                </ItemTemplate>
                                            </asp:Repeater>
                        ...
                        <table width="100%"  align="center" cellpadding="0" cellspacing="0" style="font-size: 13px;
                            ...
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th style=" width:200px; line-height:18px;">
                                        商品名称
                                    </th>
                                ...
                                <asp:Repeater ID="Repeater2" runat="server" 
                                    ...
                                    <ItemTemplate>
                                        <tr class="TbodyTr">
                                            ...
                                            <td style=" word-wrap:break-word; line-height:18px; text-align:center; width:200px;">
                                               <%#Eval("交易方名称")%> 
                                            </td>
                                            <td>
                                                <%#Eval("申请时间")%>
