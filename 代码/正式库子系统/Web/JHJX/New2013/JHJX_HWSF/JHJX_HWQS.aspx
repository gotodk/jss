<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JHJX_HWQS.aspx.cs" Inherits="Web_JHJX_New2013_JHJX_HWSF_JHJX_HWQS" MaintainScrollPositionOnPostback="false" %>
                            ...
                            <tr>
                                <td>
                                    <div class="content_nr_lb" style="width: 1110px;">
                                        <table id="theObjTable" style="width: 2010px;" cellspacing="0" cellpadding="0">
                                            <thead>
                                                <tr>
                                                    <th class="TheadTh" style="width: 120px; line-height: 18px;">货物签收时间
                                                    </th>
                                                    <th class="TheadTh" style="width: 120px;">发货单号</th>
                                                    ...
                                                    <th class="TheadTh" style="width: 120px; line-height: 18px;">卖方名称</th>
                                                    <th class="TheadTh" style="width: 120px;">卖方名称</th>
                                                    <th class="TheadTh" style="width: 120px; line-height: 18px;">卖方管理部门</th>
                                                    <th class="TheadTh" style="width: 120px;">物流公司名称</th>
                                                    <th class="TheadTh" style="width: 120px;">物流单号</th>
                                                    <th class="TheadTh" style="width: 120px;">发票编号</th>
                                                ...
                                                <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand">
                                                    <ItemTemplate>
                                                        <tr class="TbodyTr">
                                                            ...
                                                            <td>
                                                                <asp:LinkButton ID="LinkButton1" runat="server" CommandName='<%#Eval("发货单号") %>' CommandArgument="FHD"><%#Eval("发货单号")%></asp:LinkButton>
                                                            ...
                                                            <td title='<%#Eval("物流公司名称")%>'>
                                                                <div style="word-wrap: break-word; line-height: 18px; width: 110px;"><%#Eval("物流公司名称").ToString().Length > 10 ? Eval("物流公司名称").ToString().Substring(0,8) + "..." : Eval("物流公司名称").ToString()%>&nbsp;</div>
                                                            </td>
                                                            <td title='<%#Eval("物流单号")%>'>
                                                                <div style="word-wrap: break-word; line-height: 18px; width: 110px;"><%#Eval("物流单号").ToString().Length > 10 ? Eval("物流单号").ToString().Substring(0,8) + "..." : Eval("物流单号").ToString()%>&nbsp;</div>
                                                            </td>
                                                            <td title='<%#Eval("发票号码")%>'>
                                                                <div style="word-wrap: break-word; line-height: 18px; width: 110px;"><%#Eval("发票号码").ToString().Length > 10 ? Eval("发票号码").ToString().Substring(0,8) + "..." : Eval("发票号码").ToString()%>&nbsp;</div>
                                                            </td>
                                                            <td>
                                                                <asp:LinkButton ID="btnCK" runat="server" CommandName='<%#Eval("中标定标信息表编号") %>' CommandArgument="DZGHHT"><%#Eval("电子合同编号")%></asp:LinkButton>
                                                            </td>
                                                        </tr>
                                                    </ItemTemplate>
                                                </asp:Repeater>
                                            ...
                                            <tfoot>
                                                <tr id="ts" runat="server" class="TfootTr">
                                                    <td colspan="17" align="center">当前数据为空！
                                                    </td>
                                                </tr>
                                            </tfoot>
                                        </table>
