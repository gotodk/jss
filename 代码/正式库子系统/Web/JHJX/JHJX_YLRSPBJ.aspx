<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JHJX_YLRSPBJ.aspx.cs" Inherits="Web_JHJX_JHJX_YLRSPBJ" %>
...
<body style=" background-color:#f7f7f7;">
    ...
    <form id="form1" runat="server">
        ...
        <radTS:RadTabStrip ID="TabStrip1" runat="server" CausesValidation="False" ReorderTabRows="True"
                ...
                <Tabs>
                    <radTS:Tab ID="Tab1" runat="server" NavigateUrl="JHJX_YLRSPBJ.aspx" Text="预录入商品信息编辑"
                                    ...
                                    <table width="100%">
                                        <tr>
                                            ...
                                            <td  style="text-align:left;">
                                                <asp:DropDownList ID="ddlSSFL" runat="server" Width="199px" Height="25"  CssClass="tj_input" OnSelectedIndexChanged="ddlSSFL_SelectedIndexChanged" AutoPostBack="true">
                                   ...
                                   <table>
                                       <tr>
                                           <td style=" width:10px; text-align:right; vertical-align:top ">
                                            ...
                                            <td  style="text-align:left;">
                                                <asp:TextBox ID="txtSPMS" runat="server" CssClass="tj_input" Width="579px" Enabled="True"
                                    ...
                                    <table>
                                       <tr>
                                           <td style=" width:10px; text-align:right; vertical-align:top ">
                                            ...
                                            <td style=" width:120px;overflow:hidden; text-align:right; vertical-align:top ">
                                             提醒卖家重新申请：
                                            </td>
                                            <td  style="text-align:left;">
                                                <asp:CheckBox ID="ckBGZZ" runat="server" />
                                            </td>
                                       </tr>
                                   </table>
