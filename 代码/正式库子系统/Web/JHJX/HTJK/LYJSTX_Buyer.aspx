<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LYJSTX_Buyer.aspx.cs" Inherits="Web_JHJX_HTJK_LYJSTX_Buyer" %>
...
<body style="background-color: #f7f7f7;">
    ...
    <radTS:RadTabStrip ID="RadTabStrip1" runat="server" Height="25px" Skin="Default2006"
        BackColor="#F7F7F7">
        <Tabs>
            <radTS:Tab ID="Tab1" runat="server" NavigateUrl="LYJSTX_Buyer.aspx" ForeColor="red"
                Text="履约结束前买家提醒">
            </radTS:Tab>
        ...
        <div id="new_zicontent">
            <div id="content_zw">
                <div class="content_bz">
                    监控条件：距离合同结束期&nbsp;&nbsp;<span id="spanTiaoJian" runat="server" style="font-weight: bold"></span>&nbsp;&nbsp;天内，尚未完全下达提货单的买家予以汇总。不包括“即时”合同的数据。
                </div>
                        ...
                        <tr>
                            <td>
                                <div id="exprot" runat="server" style="width: 1110px;" class="content_nr_lb">
                                    <table id="theObjTable" style="width: 1820px;" cellspacing="0" cellpadding="0">
                                        <thead>
                                            <tr>
