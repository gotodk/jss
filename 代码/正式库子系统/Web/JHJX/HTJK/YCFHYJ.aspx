<%@ Page Language="C#" AutoEventWireup="true" CodeFile="YCFHYJ.aspx.cs" Inherits="Web_JHJX_HTJK_YCFHYJ" %>
...
<body style="background-color: #f7f7f7;">
    ...
    <radTS:RadTabStrip ID="RadTabStrip1" runat="server" Height="25px" Skin="Default2006"
        ...
        <Tabs>
            ...
            <radTS:Tab ID="Tab4" runat="server" NavigateUrl="YCFHYJ.aspx" ForeColor="red" Text="延迟发货预警">
            </radTS:Tab>
        </Tabs>
    </radTS:RadTabStrip>
    <div id="new_content">
        <div id="new_zicontent">
            <div id="content_zw">
                <div class="content_bz">
                    监控条件：距离最迟发货日&nbsp;&nbsp;<span id="spanTiaoJian" runat="server" style="font-weight: bold"></span>&nbsp;&nbsp;天内，尚未录入物流发货信息的卖家予以汇总。不包括“即时”合同的数据。
                </div>
                        ...
                        <tr>
                            <td>
                                <div id="exprot" runat="server" style="width: 1110px;" class="content_nr_lb">
                                    <table id="theObjTable" style="width: 1770px;" cellspacing="0" cellpadding="0">
                                        <thead>
                                            <tr>
