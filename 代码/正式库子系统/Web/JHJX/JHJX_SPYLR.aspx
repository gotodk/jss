<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JHJX_SPYLR.aspx.cs" Inherits="Web_JHJX_JHJX_SPYLR" %>
...
<body style=" background-color:#f7f7f7;">
    ...
    <form id="form1" runat="server">
        ...
        <radTS:RadTabStrip ID="TabStrip1" runat="server" CausesValidation="False" ReorderTabRows="True"
                ...
                <Tabs>
                    <radTS:Tab ID="Tab1" runat="server" NavigateUrl="JHJX_SPYLR.aspx" Text="预录入商品信息添加"
                        ...
                        <tfoot>
                            ...
                            <tr>
                                <td colspan="2" class="TitleTh">
                                    商品资质要求<span style="color:red;">（资质名称不能带有“|”）</span></td>
                            </tr>
                        </tfoot>
                    </table>        
