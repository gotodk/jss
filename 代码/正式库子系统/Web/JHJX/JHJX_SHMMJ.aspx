<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JHJX_SHMMJ.aspx.cs" Inherits="Web_JHJX_JHJX_SHMMJ" %>
                                ...
                                <table id="theObjTable" style="width: 100%;" cellspacing="0" cellpadding="0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="TheadTh" style="width: 9%">
                                                手机号
                                            </th>                                           
                                            <th class="TheadTh" style="width: 9%">
                                                注册时间
                                            ...
                                            <ItemTemplate>
                                                <tr class="TbodyTr">
                                                    ...
                                                    <td>
                                                      ...
                                                      <td>
                                                        <%#Eval("结算账户")%>
                                                        <asp:HiddenField ID="hidJSLX" runat="server" Value='<%#Eval("结算账户")%>' />
                                                    </td>
                                                    <td>
                                                        <%#Eval("登录邮箱")%>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <asp:LinkButton ID="linkSee" runat="server" CommandName="linkSee" CommandArgument='<%#Eval("角色编号")+"#"+Eval("关联经纪人账号")+"#"+Eval("登录邮箱")%>'>审核资料</asp:LinkButton>
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
                                        </asp:Repeater>
