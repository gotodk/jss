<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PTKPXXChange_Check.aspx.cs"
    Inherits="Web_JHJX_PTKPXXChange_Check" %>
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" class="content_nr_cx" style="border: solid 1px #ccc">
                        ...
                        <tr>                            
                            ...
                            <td style="text-align: left; width: 70px;">
                                <asp:DropDownList ID="ddlCLZT" runat="server" CssClass="tj_input" Width="70px">
                                    <asp:ListItem Value="">全部</asp:ListItem>
                                    <asp:ListItem Selected="True">待处理</asp:ListItem>
                                    <asp:ListItem>已修改</asp:ListItem>
                                        ...
                                        <asp:Repeater ID="rptKPXX" runat="server" OnItemDataBound="rptKPXX_ItemDataBound"
                                            ...
                                            <ItemTemplate>
                                                <tr class="TbodyTr">
                                                    ...
                                                    <td>
                                                        <asp:Label ID="lblCLZT" runat="server" Text='<%#Eval("clzt")%>'> </asp:Label>
                                                    </td>
                                                    <td title='<%#Eval("createtime")%>'>
                                                        <%#Eval("createtime")%>
                                                    </td>
                                                    <td>
                                                        <asp:LinkButton ID="lkbtnCheck" runat="server" CommandName="linkbj" CommandArgument='<%#Eval("id")%>'>审核处理</asp:LinkButton>
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
                                        </asp:Repeater>
