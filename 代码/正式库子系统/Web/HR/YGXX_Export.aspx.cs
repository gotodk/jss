...
public partial class Web_HR_YGXX_Export : System.Web.UI.Page
{
    ...
    //导出调岗记录的数据
    protected void Button_tiaogang_Click(object sender, EventArgs e)
    {
        this.UltraWebGridExcelExporter2.DownloadName = "TiaoGang.xls";
        this.UltraWebGridExcelExporter2.Export(this.UltraWebGrid2);
    }
