<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Employees_List_JB.aspx.cs" Inherits="Web_HR_Employees_List_JB" %>
...
<body>
    <form id="form1" runat="server">
     ...
     <Tabs>
        <radTS:Tab ID="Tab1" runat="server" Text="在职员工档案查询(基本信息)">
            </radTS:Tab>
     </Tabs>
     </radTS:RadTabStrip>
      <table border="0" cellpadding="0" cellspacing="0" style="width: 90%">
            <tr>
                <td style="width: 100%" align="right">
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    隶属：<asp:DropDownList
                        ID="DropDownListLS" runat="server">
                    </asp:DropDownList>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    部门：<asp:DropDownList
