<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RZRY_Report.aspx.cs" Inherits="Web_HR_RYYD_RZRY_Report" %>
    ...
    <div>
        ...
        <table border="0" cellpadding="5" cellspacing="0" class="FormView">
            <tr>
                ...
                <td width="100" align="right" rowspan="2" valign="middle">
                    <asp:Button ID="Button2" runat="server" Text="查看结果" Width="90px" OnClick="Button1_Click1" />
                </td>
                <td width="100" align="left" rowspan="2" valign="middle">
                    <asp:Button ID="Button4" runat="server" OnClick="Button3_Click" Text="导出到Excel" Width="90px" />
                </td>
            </tr>
        </table>
        <table>
                ...
                <td>
                 <div id="divDaoChu" runat="server">
                        <table id="tbtitle" runat ="server" visible ="false" width="100%" cellpadding="0" cellspacing="0" border="1">
                            <tr>
                                <td colspan="10" align="center" valign="middle" style="font-size: 10pt; font-weight: bold;
                                    height: 30px">
                    ...
                    <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="员工工号" HeaderText="员工工号" ItemStyle-Width="80px"></asp:BoundField>
                            <asp:BoundField DataField="员工姓名" HeaderText="员工姓名" ItemStyle-Width="80px"></asp:BoundField>
                            ...
                            <asp:BoundField DataField="入职月份" HeaderText="入职月份" ItemStyle-Width="80px"></asp:BoundField>
                            <asp:BoundField DataField="入职时间" HeaderText="入职时间" ItemStyle-Width="100px"></asp:BoundField>
                            <asp:BoundField DataField="用工形式" HeaderText="用工形式" ItemStyle-Width="80px"></asp:BoundField>
                            <asp:BoundField DataField="试用期" HeaderText="试用期" ItemStyle-Width="150px"></asp:BoundField>
                            <asp:BoundField DataField="备注" HeaderText="备注" ItemStyle-Width="120px"></asp:BoundField>
                        </Columns>
                    </asp:GridView>
                    </div> 
                </td>
