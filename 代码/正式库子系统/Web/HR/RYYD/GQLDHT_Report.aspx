<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GQLDHT_Report.aspx.cs" Inherits="Web_HR_RYYD_GQLDHT_Report" %>
                    ...
                    <div id="divDaoChu" runat="server">
                        ...
                        <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="劳动合同签订月份" HeaderText="劳动合同签订月份" ItemStyle-Width="80px">
                                </asp:BoundField>
                                <asp:BoundField DataField="劳动合同开始时间" HeaderText="劳动合同开始时间" ItemStyle-Width="80px">
                                </asp:BoundField>
                                <asp:BoundField DataField="试用期" HeaderText="试用期" ItemStyle-Width="180px"></asp:BoundField>
                                <asp:BoundField DataField="原用工形式" HeaderText="原用工形式" ItemStyle-Width="100px"></asp:BoundField>
