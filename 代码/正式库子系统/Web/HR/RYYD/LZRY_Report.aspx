<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LZRY_Report.aspx.cs" Inherits="Web_HR_RYYD_LZRY_Report" %>
                ...
                <td>
                    <div id="divDaoChu" runat="server">
                        <table id="tbtitle" runat ="server" visible ="false" width="100%" cellpadding="0" cellspacing="0" border="1">
                            <tr>
                                <td colspan="8" align="center" valign="middle" style="font-size: 10pt; font-weight: bold;
                                    height: 30px">
                        ...
                        <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="离职月份" HeaderText="离职月份" ItemStyle-Width="100px"></asp:BoundField>
                                <asp:BoundField DataField="离职时间" HeaderText="离职时间" ItemStyle-Width="100px"></asp:BoundField>
