<%@ Page Language="C#" AutoEventWireup="true" CodeFile="YGXX_Export.aspx.cs" Inherits="Web_HR_YGXX_Export" %>
...
<body>
    ...
    <radTS:RadTabStrip ID="RadTabStrip1" runat="server" Skin="Default2006" 
     ...
     <Tabs>
     <radTS:Tab ID="Tab1" runat="server" Text="员工档案信息导出"></radTS:Tab>
     </Tabs>
     </radTS:RadTabStrip>
     
     
     <table style="width: 900px">          
          <tr><td align="right">导出员工基本信息</td><td align="right" style="width:50%"><asp:Button 
        ...
        <igtbl:UltraWebGrid ID="UltraWebGrid1" runat="server" Height="240px" 
           ...
           <DisplayLayout AllowColSizingDefault="Free" AllowColumnMovingDefault="OnServer" 
                ...
                <FrameStyle BackColor="Window" BorderColor="InactiveCaption" 
                    ...
                    Font-Size="8.25pt" Height="241px" Width="900px">
                </FrameStyle>
    ...
    <igxl:UltraWebGridExcelExporter ID="UltraWebGridExcelExporter1" runat='server'  OnInitializeRow="UltraWebGridExcelExporter1_InitializeRow" OnBeginExport="UltraWebGridExcelExporter1_BeginExport">            
         ...
         <tr><td style ="height:10px"></td></tr>         
          <tr>
            <td align="right">导出员工调岗记录</td>
            <td align="right" style="width:50%"><asp:Button ID="Button_tiaogang" runat="server" onclick="Button_tiaogang_Click" Text="导出到Excel" Visible="True" Width="120px" /></td>
          </tr>
         </table> 
         
          <igtbl:UltraWebGrid ID="UltraWebGrid2" runat="server" Height="240px" 
              Width="900px" DataSourceID="SqlDataSource2">
              <Bands>
                  <igtbl:UltraGridBand>
                      <AddNewRow View="NotSet" Visible="NotSet">
                      </AddNewRow>
                      <Columns>
                          <igtbl:UltraGridColumn BaseColumnName="YGBH" IsBound="True" Key="YGBH">
                              <Header Caption="员工编号">
                              </Header>
                          </igtbl:UltraGridColumn>
                          <igtbl:UltraGridColumn BaseColumnName="XM" IsBound="True" Key="XM">
                              <Header Caption="员工姓名">
                                  <RowLayoutColumnInfo OriginX="1" />
                              </Header>
                              <Footer>
                          ...
                          <igtbl:UltraGridColumn BaseColumnName="YBM" IsBound="True" Key="YBM">
                              <Header Caption="原部门">
                                  <RowLayoutColumnInfo OriginX="2" />
                              </Header>
                              <Footer>
                          ...
                          <igtbl:UltraGridColumn BaseColumnName="YGW" IsBound="True" Key="YGW">
                              <Header Caption="原岗位">
                                  <RowLayoutColumnInfo OriginX="3" />
                              </Header>
                              <Footer>
                          ...
                          <igtbl:UltraGridColumn BaseColumnName="TWGW" IsBound="True" Key="TWGW">
                              <Header Caption="调往岗位">
                                  <RowLayoutColumnInfo OriginX="4" />
                              </Header>
                              <Footer>
                          ...
                          <igtbl:UltraGridColumn BaseColumnName="TWBM" IsBound="True" Key="TWBM">
                              <Header Caption="调往部门">
                                  <RowLayoutColumnInfo OriginX="5" />
                              </Header>
                              <Footer>
                          ...
                          <igtbl:UltraGridColumn BaseColumnName="DGSJ" DataType="System.DateTime" 
                              IsBound="True" Key="DGSJ">
                              <Header Caption="到岗时间">
                                  <RowLayoutColumnInfo OriginX="6" />
                              </Header>
                              <Footer>
                          ...
                          <igtbl:UltraGridColumn BaseColumnName="TGRZZT" IsBound="True" Key="TGRZZT">
                              <Header Caption="调岗任职状态">
                                  <RowLayoutColumnInfo OriginX="7" />
                              </Header>
                              <Footer>
                                  <RowLayoutColumnInfo OriginX="7" />
              ...
              <DisplayLayout AllowColSizingDefault="Free" AllowColumnMovingDefault="OnServer" 
                ...
                <FrameStyle BackColor="Window" BorderColor="InactiveCaption" 
                    BorderStyle="Solid" BorderWidth="1px" Font-Names="Microsoft Sans Serif" 
                    Font-Size="8.25pt" Height="215px" Width="900px">
                </FrameStyle>
                <Pager MinimumPagesForDisplay="2">
                    <PagerStyle BackColor="LightGray" BorderStyle="Solid" BorderWidth="1px">
                    <BorderDetails ColorLeft="White" ColorTop="White" WidthLeft="1px" 
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
        ConnectionString="<%$ ConnectionStrings:FMOPConn %>" 
        SelectCommand="SELECT [YGBH], [XM], [YBM], [YGW], [TWGW], [TWBM], convert(varchar(10),[DGSJ],120) as [DGSJ], [TGRZZT] FROM [RLZY_YGGX_TGGL] ORDER BY [YGBH], [DGSJ]">
    </asp:SqlDataSource>
    <igxl:UltraWebGridExcelExporter ID="UltraWebGridExcelExporter2" runat="server">
    </igxl:UltraWebGridExcelExporter>
    </form>
</body>
</html>
