...
<head id="Head1" runat="server">
    <title>选择画面</title>
    <base target ="_self" />
    <script src ="../js/common-private.js" type ="text/javascript" language ="javascript"></script> 
...
<body  style="margin: 0px;">
    ...
    <div style="BORDER:0px;PADDING:0px;MARGIN:0px;OVERFLOW:auto;WIDTH:600px;HEIGHT:450px">
        <radG:RadGrid ID="saleGrid" runat="server" AllowPaging="True" OnPageIndexChanged="RadGrid1_PageIndexChanged" GridLines="None"  AutoGenerateColumns="False" OnItemDataBound="saleGrid_ItemDataBound" AllowSorting="True"
         PagerStyle-CssClass="GridPager"
          PagerStyle-Height="20px" PagerStyle-PagerTextFormat="{4} &nbsp;|&nbsp;&nbsp;&nbsp;{0}&nbsp;/&nbsp;{1}&nbsp;页;&nbsp;&nbsp;(&nbsp;{2}&nbsp;-{3}&nbsp;)&nbsp;条记录&nbsp;&nbsp;,共{5}条"
          PagerStyle-VerticalAlign="Top" SortingSettings-SortedAscToolTip="升序" SortingSettings-SortedDescToolTip="降序"
          SortingSettings-SortToolTip="按此项排序" Width="800px" Skin="Default" ShowGroupPanel="True" MasterTableView-NoMasterRecordsText="没有可显示的记录" GroupPanel-Text="可拖动此项至表格上方的区域进行分组" GroupingSettings-GroupContinuesFormatString="接下页..." GroupingSettings-GroupContinuedFormatString="接上页" GroupingSettings-GroupSplitDisplayFormat="共有{1}条记录，本页显示{0}条." HierarchySettings-ExpandTooltip="展开" HierarchySettings-CollapseTooltip="折叠"  GroupingSettings-ExpandTooltip="展开" GroupingSettings-CollapseTooltip="折叠" PagerStyle-Mode="NextPrev">
            <ExportSettings>
        ...
        <table>
        <tr><td><input type ="button" value="条件查询" id="execQuery" onclick="display();"/></td><td><input type ="button" value="取消条件查询" id="cancelQuery" onclick="cancelQualification();"/></td></tr>
        </table>
        </div>
