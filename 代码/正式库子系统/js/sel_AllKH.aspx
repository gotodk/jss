<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sel_AllKH.aspx.cs" Inherits="js_sel_AllKH" %>
...
function openSelect_FWS(){
    ...
    ShowDialog('../Web/AllKeHuList.aspx?cs='+encodeURI(cs),'800','600');  
}
...
$(document).ready(function(){
    ...
    $("#btnKHBH").click(function(){openSelect_FWS()});  //重新设置onclick，将其指向一个新的选择页面   
}); 
