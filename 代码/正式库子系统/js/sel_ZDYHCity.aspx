<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sel_ZDYHCity.aspx.cs" Inherits="js_sel_ZDYHCity" %>
...
function openSelect_ZDYH(){
    ...
    ShowDialog('../Web/ZDYHList.aspx?cs='+encodeURI(cs),'800','600');  
}
...
$(document).ready(function(){
    ...
    $("#btnDWMC").attr("onclick","");  //去掉服务商选择的onclick事件
    $("#btnDWMC").click(function(){openSelect_ZDYH()});  //重新设置onclick，将其指向一个新的选择页面   
}); 