...
function writeIframe()
{
    ...
    "</td></tr><tr><td height='20px'><table id=tableWeek border=1 width='140px' cellpadding=0 cellspacing=0 ";
    ...
    "    <table id=tableDay height='120px' width='140px' border=0 cellspacing=1 cellpadding=0>";
         for(var x=0; x<5; x++){
           strIframe += "<tr>";
           for(var y=0; y<7; y++)
    ...
    "    <table border=0 cellpadding=1 cellspacing=0 width='140px'>"+
