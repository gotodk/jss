<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CWGL_KGSYQKQCSJ.aspx.cs" Inherits="js_CWGL_KGSYQKQCSJ" %>
...
function openSelect_ERPDD(){
    ...
    ShowDialog('../Web/CWGL/sel_ERPKHXX.aspx?cs='+encodeURI(cs),'800','600');  
}
...
function repeat(){
     $("#btnCWGL_KHKGSYQKQCSJ_KGQCXXKGPH").attr("onclick","");  //去掉空鼓回收选择的onclick事件
     document.getElementById("btnCWGL_KHKGSYQKQCSJ_KGQCXXKGPH").onclick =openSelect_ERPKGHS;
