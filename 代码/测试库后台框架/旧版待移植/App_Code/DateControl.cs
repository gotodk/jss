...
namespace FMOP.DATE
{
    public class DateControl : Controls
    {
        ...
        public string MakeDate(string htmlStr)
        {
            ...
            if (ReadOnly == true)
            {
                DateHtml.Append("style=\"ime-mode:Disabled\" onkeypress=\"return false;\"\r\n");
            }
            ...
            if (HasModelButton == true)
            {
                ...
                {
                    DateHtml.Append("\t<input type=\"button\" name=\"openWin\" value=\"..\" class=\"smallbutton\" onclick=\"ShowDialog('ChildWin.aspx?moduleName=" + ModuleName + "&fieldName=" + Name + "&tableName=" + SubTable + "','400','300');\"/>\r\n");
                }
            }
