...
{
	/// <summary>
	/// ShootSearch 分词组件 1.0 bate 060830
	/// http://www.shootsoft.net
	/// support@shootsoft.net
	/// 2006Y07M01D
	/// </summary>
	public class Segment
	{
        private string m_DicPath = HttpContext.Current.Request.PhysicalApplicationPath + "/ShootSegData/sDict.txt";
        private string m_NoisePath = HttpContext.Current.Request.PhysicalApplicationPath + "/ShootSegData/sNoise.txt";
        private string m_NumberPath = HttpContext.Current.Request.PhysicalApplicationPath + "/ShootSegData/sNumber.txt";
        private string m_WordPath = HttpContext.Current.Request.PhysicalApplicationPath + "/ShootSegData/sWord.txt";
        private string m_PrefixPath = HttpContext.Current.Request.PhysicalApplicationPath + "/ShootSegData/sPrefix.txt";
