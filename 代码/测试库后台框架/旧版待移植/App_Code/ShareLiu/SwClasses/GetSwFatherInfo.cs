...
/// <summary>
///GetSwFatherInfo 的摘要说明
/// </summary>
namespace ShareLiu.SwClasses
{
    public class GetSwFatherInfo
    {
        public GetSwFatherInfo()
        {
            //
            //TODO: 在此处添加构造函数逻辑
            //
        ...
        public static SwFatherObj GetSw(string id)
        {
            ...
            sql="select * from SWcreate where smid='"+id+"'";
            ...
            if (sr.Read())
            {
              ...
              //  sf.Spname = sr["spname"].ToString();
                ...
                sf.TextAre = sr["TexArea"].ToString();
                sf.Islocked = int.Parse(sr["islocked"].ToString());
        ...
        {
            int rcount = 0;
            string sql = "update SWcreate set smstates='"+Fstates.Trim()+"' where smid='" +SmId.Trim() + "'";
        ...
        {
            string delsql = "delete from SwSqRecord where smid='" +Smid+ "'";
