    ...
    public class FileUp : Controls
    {
        ...
        public string MakeFileUp(string htmlStr)
        {
            ...
            if (HasModelButton == true)
            {
                ...
                {
                    FileUpHtml.Append("\t<input type=\"button\" name=\"openWin\" value=\"..\" class=\"button\" onclick=\"ShowDialog('MasterWin.aspx?moduleName=" + ModuleName + "&fieldName=" + Name + "&tableName=" + SubTable + "','600','450');\"/>\r\n");
                }
            }
