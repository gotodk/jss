...
namespace FMOP.IB
{
    public class IntBox : Controls
    {
        ...
        public string MakeIntBox(string htmlStr)
        {
            ...
            if (ReadOnly == true)
            {
                IntBoxHtml.Append("style=\"ime-mode:Disabled\" onkeypress=\"return false;\"\r\n");
            }
            ...
            if (HasModelButton == true)
            {
                ...
                {
                    IntBoxHtml.Append("<input type=\"button\" name=\"openWin\" value=\"..\" class=\"smallbutton\" onclick=\"ShowDialog('ChildWin.aspx?moduleName=" + ModuleName + "&fieldName=" + Name + "&tableName=" + SubTable + "','600','450');\"/>");
                }
            }
