...
public partial class pagerdemo_mobliepager : System.Web.UI.UserControl
{
    ...
    public void GetFYdataAndRaiseEvent()
    {
        ...
        {
            fmdivpage.Visible = true;
        }
        else
        {
            fmdivpage.Visible = false;
        }
        //更新文字描述信息 
        nowpagenum.InnerHtml = (Convert.ToInt32(ViewState["page_index"]) + 1).ToString();
        allpagenum.InnerHtml = ViewState["page_count"].ToString();
    ...
    public DataSet getDataSet_FY(string dg_once)
    {
        ...
        else
        {
            ...
            if (ViewState["this_dblink"].ToString() == "yikatong")
            {
                csstr = "CardConn";
            }
