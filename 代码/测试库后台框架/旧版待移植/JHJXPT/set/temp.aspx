<%@ Page Language="C#" AutoEventWireup="true" CodeFile="temp.aspx.cs" Inherits="JHJXPT_set_temp" %>
    ...
    <table width="100%" border="1">
      <tr>
        ...
        <td class="style1">数据库表：<asp:DropDownList ID="TBTable" runat="server">
            <asp:ListItem Selected="True">ZZ_tbMenuSPFLtemp</asp:ListItem>
            </asp:DropDownList>
            <br />
      ...
      <tr>
        ...
        <td class="style3">一级分类的名称不超过四个汉字。 二级分类及以下，名称不超过十个汉字<br />
            父级SortID(0是顶级):<asp:TextBox ID="ADD_TBFID" runat="server" 
      ...
      <tr>
        ...
        <td class="style4">
            <asp:Button ID="Button3" runat="server" Text="隐藏" onclick="Button3_Click" 
                OnClientClick="javascript:return confirm('确定要隐藏选中的节点吗？');" Visible="False"  />
      ...
      <tr>
        ...
        <td>
            <asp:Button ID="Button6" runat="server" Text="重新整理纠错，危险" 
                ...
                OnClientClick="javascript:return confirm('确定要重新整理菜单吗？');" Visible="False" />
          </td>
      </tr>
    </table>
