<%@ Page Language="C#" AutoEventWireup="true" CodeFile="getsy002.aspx.cs" Inherits="mywork_getsy002_" ResponseEncoding="gb2312" %>
...
<body>
    <form id="form1" runat="server">
        <jieduan>
              <%-- 商品排名TOP10 最近220个交易日（含当日）累计成交额前10名的商品 --%>
...
<tr>
                ...
                <td class="ziti_lan" title="<%# ((System.Data.DataRowView)Container.DataItem)["s1"]%>"><%# CutString(((System.Data.DataRowView)Container.DataItem)["s1"].ToString(),8)%></td>
