<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JJRCX_SY.aspx.cs" Inherits="mywork_GXTW_JJRCX_SY" %>
    ...
    <div class="content_nr" id="divLB" runat="server" style=" width:800px; margin-left:50px; text-align:left;">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0">
            <tr>
                <td align="left">
                    <div class="tab1">
                        <ul id="test1_li_now">
                            <li ><a id="aJJRSYCX" runat="server" href="JJRCX.aspx">经纪人信息查询</a></li>
                            <li class="now"><a id="aJJRXXCX" runat="server" href="JJRCX_SY.aspx">经纪人收益查询</a></li>
                        </ul>
                    </div>
                </td>
            </tr>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" class="content_nr_cx" style="border: solid 1px #ccc">                        
                    ...
                    <table align="left" cellpadding="0" cellspacing="0" class="table_nr" style=" width:100%; margin-left:0px;">
                        <tr>
                            <td align="left" style="height: 25px; width:400px;" valign="bottom" class="title">
                                当前经纪人收益总额：<asp:Label ID="lblJJRSYZJE" runat="server" Text="Label"></asp:Label>
                            </td>
                            <td style="text-align:right; width:400px;" valign="bottom" class="title">（金额单位：元）</td>
                        </tr>
                        <tr>
                            <td colspan="2">
                                <table cellspacing="0" cellpadding="0" border="1px" bordercolor="#D1CFCF" style="border-style: solid;
                                    ...
                                    <thead>
                                        <tr style="background-color: #D6E3F3; font-weight: bold;">                                            
                                            ...
                                            <td height="28" width="130px">
                                                收益产生时间
                                            </td>
                                            <td height="28" width="120px">
                                                收益产生来源
                                            </td>
                                            <td height="28" width="80px">
                                                收益金额
                                            </td>
                                            <td height="28" width="120px">
                                                当前收益总额
                        ...
                        <table cellspacing="0" cellpadding="0" border="1px" bordercolor="#D1CFCF" style="border-style: solid;
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th height="28" width="130px">
                                                收益产生时间
                                            </th>
                                            <th height="28" width="120px">
                                                收益产生来源
                                            </th>
                                            <th height="28" width="80px">
                                                收益金额
                                            </th>
                                            <th height="28" width="120px">
                                                当前收益总额
