<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JYPT_SHJYJL_ZLBZ.aspx.cs"
    Inherits="mywork_JYPT_JYPT_SHJYJL_ZLBZ" %>

<%@ Register Src="../../pagerdemo/commonpager.ascx" TagName="commonpager" TagPrefix="uc2" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>中国商品批发交易平台-验收货经验交流-质量标准</title>
                ...
                <td align="left">
                    <div class="tab1">
                        <ul id="test1_li_now">
                            ...
                            <li class="now"><a id="aZLBZ" runat="server">质量标准</a></li>
                        </ul>
                    </div>
                </td>
            </tr>
        </table>
        <table align="center" cellpadding="0" cellspacing="0" class="table_nr" width="700px">
            <tr>
                <td align="left" height="25px">
                    <span class="title ">平台现用质量标准：</span> <span id="spanXYNR" runat="server" style="line-height: 20px">
                    </span>
                </td>
            </tr>
            <%--  <tr>
            ...
            <tr>
                <td align="left" style="height: 30px" valign="bottom" class="title">
                    用户建议质量标准
                </td>
            </tr>
            <tr>
                        ...
                        <tfoot id="tempty" runat="server">
                            <tr>
                                <td height="28" colspan="4">
                                    <asp:Label ID="Label1" runat="server" Text="暂时没有此商品的建议质量标准，您可以提供您的建议。"></asp:Label>
                                </td>
                            </tr>
                        </tfoot>
                    </table>
            ...
            <tr runat="server" id="trTJ">
                <td>
                    <table cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            <td align="left" valign="bottom" height="80px">
                                <asp:TextBox ID="txtSPXMC" runat="server" Width="580px" Height="80px" TextMode="MultiLine"
                                    CssClass="tj_input_M" onKeyUp="textCounter(this,'divBZ',100)"></asp:TextBox>
                            </td>
                            <td width="10px">
                            </td>
                        ...
                        <tr>
                            <td align="right">
                                ...
                                <script type="text/javascript">                                    textCounter(document.getElementById("txtSPXMC"), "divBZ", 100)</script>
                            </td>
                            <td>
                            </td>
                        </tr>
            ...
            <tr runat="server" id="trCK">
                <td style="padding-left: 30px" align="left" height="30px">
                    <asp:Label ID="lblCK" runat="server" Text="" Style="line-height: 20px"></asp:Label>
                </td>
            </tr>
        </table>
    </div>
