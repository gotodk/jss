    ...
    <form id="form1" runat="server">
        <div style="width: 700px">
            ...
            <table align="center" cellpadding="0" cellspacing="0" class="table_nr">
                ...
                <tr>
                    <td>
                        <table cellspacing="0" cellpadding="0" style="border: 1px; border-color: #D1CFCF; border-style: solid; border-collapse: collapse; text-align: center; width: 670px;">
                            <thead>
                        ...
                        <table cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                <td align="left" valign="bottom">
                                    <asp:TextBox ID="txtSPXMC" runat="server" Width="580px" Height="100px" TextMode="MultiLine"
