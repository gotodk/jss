...
public class ChengjiaoService
{
    ...
    public static DataSet Jhjx_DB(DataTable dt)
    {
        ...
        if (action == "ok")
        {
            ...
            DataSet ds = IsMoneyDZB.ReadRedisMoneyDZB(new string[] { "1304000005" }, null,null);
            ...
            //执行完成
                if (ds != null && ds.Tables[0].Rows.Count == 1 && dsobj != null && dsobj.Tables[0].Rows.Count > 0)
                {
                    ...
                    DataSet dsdj = IsMoneyDZB.ReadRedisMoneyDZB(new string[] { "1304000047" }, null, null);
   ...
   //dstx.Tables["1"].Rows.Add(drmes);
            ...
            if (dt_YDD.Rows.Count == 1)
            {
                ...
                if (YDSL < TBSL)
                {
                    ...
                    if (((TBSL - YDSL) < MJSDJJPL) && (TBSL - YDSL) != 0)
                    {
                        ...
                        #endregion
                        DataTable dt_LSDZ = IsMoneyDZB.ReadRedisMoneyDZB(new string[] { "1304000004" }, null, null).Tables["MoneyDZB"];
    ...
    private static void BeginDapanOneGroup(object SPBH)
    {
        ...
        try
        {
            ...
            if ((bool)returnHT["return_float"])
            {
                //增加Redis更新。 将商品的统计信息写入redis中
                PrdTongJi.SetPrdTongJi_from_AAA_DaPanPrd_Get((DataSet)returnHT["return_ds"]);
    ...
    public static DataSet CreatNewDapanList_Group_Run( string SQLdapan_lujing, string SQLdibu_lujing)
    {
        ...
        try
        {
            ...
            */
            ...
            //写入Redis缓存
            HomePageRedis.UpdateHomePageByte(b);
            ...
            //写入Redis缓存
            HomePageRedis.UpdateJHXP(b_shangpinS);
            ...
            //写入Redis缓存
            HomePageRedis.UpdateHomePageByte_tongji(b_tongji);
        ...
        try
        {
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                if (YZBSL == "0")
                {
                    ...
                    #endregion
                    DataTable dt_LSGZ = IsMoneyDZB.ReadRedisMoneyDZB(new string[] { "1304000019" }, null, null).Tables["MoneyDZB"];
    ...
    public static DataSet RunFHYC()
    {
        ...
        try
        {
            ...
            if (dsYC != null && dsYC.Tables[0].Rows.Count > 0)
            {
                ...
                #endregion
                DataSet dsDZB = IsMoneyDZB.ReadRedisMoneyDZB(new string[] { "1304000027", "1304000051" }, null, null);
    ...
    public static DataSet RunFPYC()
    {
        ...
        try
        {
            ...
            if (dsYC != null && dsYC.Tables[0].Rows.Count > 0)
            {
                ...
                //DataSet dsDZB = (DataSet)htCS1["return_ds"];
                #endregion
                DataSet dsDZB = IsMoneyDZB.ReadRedisMoneyDZB(new string[] { "1304000029", "1304000050" }, null, null);
        ...
        try
        {
           ...
           if (!(bool)returnHT["return_float"])
            ...
            if (dsFB != null && dsFB.Tables[0].Rows.Count > 0)
            {
                ...
                #endregion
                DataSet dsDZB = IsMoneyDZB.ReadRedisMoneyDZB(new string[] { "1304000021" }, null, null); 
    ...
    {  
        ...
        try
        {
            ...
            if (dsgetinfo != null && dsgetinfo.Tables[0].Rows.Count > 0)
            {
                ...
                #endregion
                DataSet dshkjd = IsMoneyDZB.ReadRedisMoneyDZB(new string[] { "1304000010", "1304000012", "1304000014", "1304000007", "1304000043", "1304000042", "1304000048", "1304000028", "1304000037", "1304000026", "1304000036" }, new string[] { "登录邮箱", "结算账户类型", "角色编号", "来源单号", "流水产生时间", "运算类型", "金额" }, null);
...
E、收入>62500 ，应纳税额=收入*0.8*0.4-7000，税后所得=收入-应纳税额
    ...
    public static DataSet ServerCQWJNLYBZJJK()
    {
        ...
        try
        {
            ...
            #endregion
            DataSet ds_ZKMX = IsMoneyDZB.ReadRedisMoneyDZB(new string[] { "1304000020", "1304000006", "1304000035", "1304000025" }, null, null);
