...
namespace 客户端主程序.NewDataControl
{
    public class GetTHDFPXX
    {
        ...
        public GetTHDFPXX(Hashtable PHT, delegateForThread DFT)
        {
            //
            // TODO: 在此处添加构造函数逻辑
            //
        ...
        public void BeginRun()
        {
            ...
            //DataSet dsreturn = WSC2013.RunAtServices("GetTHDFP", cs);
            //已移植可替换(已替换)
            DataSet dsreturn = WSC2013.RunAtServices("C获取买家最近一次发票信息", cs);
