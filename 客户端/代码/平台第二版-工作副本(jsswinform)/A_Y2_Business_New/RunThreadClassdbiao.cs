...
{
    public class RunThreadClassdbiao
    {
        ...
        public RunThreadClassdbiao(Hashtable PHT, delegateForThread DFT)
        {
            //
            // TODO: 在此处添加构造函数逻辑
            //
        ...
        public void BeginRun()
        {
         ...
         //   DataSet dsreturn = WSC2013.RunAtServices("Jhjx_db", cs);
            DataSet dsreturn = WSC2013.RunAtServices("C定标", cs);
            //填充传入参数哈希表
