...
namespace 客户端主程序.NewDataControl
{
    ...
    /// 用于用户自己修改密码
    /// </summary>
    public class OPenThreadPsdChange
    {
        //向线程传递的回调参数
        ...
        public OPenThreadPsdChange(Hashtable PHT, delegateForThread DFT)
        {
            //
            // TODO: 在此处添加构造函数逻辑
            //
        ...
        public void BeginRun()
        {
            ...
            object[] cs = { dt };
            //已移植可替换(已替换)
            //DataSet dsreturn = WSC2013.RunAtServices("PsdChange", cs);
            DataSet dsreturn = WSC2013.RunAtServices("C用户修改密码", cs);
            //填充传入参数哈希表
        ...
        public void RunZQZJMMChange()
        {
            ...
            object[] cs = { dt };
            //已移植可替换(已替换)
            //DataSet dsreturn = WSC2013.RunAtServices("RunZQZJMMChange", cs);
            DataSet dsreturn = WSC2013.RunAtServices("C修改证券资金密码", cs);
