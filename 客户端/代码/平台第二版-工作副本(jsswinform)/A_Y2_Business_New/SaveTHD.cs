...
namespace 客户端主程序.NewDataControl
{
    public class SaveTHD
    {
        ...
        public SaveTHD(DataSet PHT, delegateForThread DFT)
        {
            //
            // TODO: 在此处添加构造函数逻辑
            //
        ...
        public void BeginRun()
        {
            ...
            //InPutHT可以选择灵活使用
            object[] cs = { InPutHT };
            //DataSet dsreturn = WSC2013.RunAtServices("SaveTHD", cs);
            //已移植可替换(已替换)
            DataSet dsreturn = WSC2013.RunAtServices("C下达提货单", cs);
