   ...
   public class THDCK
    {
        ...
        public THDCK(Hashtable PHT, delegateForThread DFT)
        {
            //
            // TODO: 在此处添加构造函数逻辑
            //
        ...
        public void BeginRun()
        {
            ...
            //InPutHT可以选择灵活使用
            object[] cs = { InPutHT["THDBH"].ToString() };
            //DataSet dsreturn = WSC2013.RunAtServices("CKTHD", cs);
            //已移植可替换(已替换)
            DataSet dsreturn = WSC2013.RunAtServices("C提货单详情", cs);
