...
{
    public partial class UCdzghxy : UserControl
    {
        Hashtable HTcs;
        public UCdzghxy()
        {
        ...
        private void UCdzghxy_Load(object sender, EventArgs e)
        {
            //获取参数
        ...
        private void BeginShow()
        {
            ...
            try
            {
                ...
                label1.Text = (Convert.ToInt32(Math.Ceiling( Convert.ToDouble(height / pictureBox1.Height))) + 1).ToString(); //无条件进位
            }
