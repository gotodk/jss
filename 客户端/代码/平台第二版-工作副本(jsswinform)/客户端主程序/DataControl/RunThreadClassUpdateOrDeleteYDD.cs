...
{
    class RunThreadClassUpdateOrDeleteYDD
    {
        //向线程传递的回调参数
        private delegateForThread DForThread;
        //向线程传递的数据参数
        private DataSet InPutdsCS;
        /// <summary>
        /// 构造函数
        /// </summary>
        /// <param name="dsCS">需要传入线程的参数</param>
        /// <param name="DFT">线程委托</param>
        public RunThreadClassUpdateOrDeleteYDD(DataSet dsCS, delegateForThread DFT)
        {
            //
            // TODO: 在此处添加构造函数逻辑
            //
        ...
        public void BeginRun()
        {
            ...
            string returnds = WSC.UpdateOrDeleteYDD(InPutdsCS);


            //填充传入参数哈希表
            Hashtable OutPutHT = new Hashtable();
            OutPutHT["执行结果"] = returnds;//测试参数
            DForThread(OutPutHT);
