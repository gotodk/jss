...
namespace 客户端主程序.DataControl
{
    ...
    class RunThreadClassLYBZJ
    {
        ...
        public RunThreadClassLYBZJ(string zhubiaoT, string zibiaoT, string jsbhT, delegateForThread DFT)
        {
            //
            // TODO: 在此处添加构造函数逻辑
            //
        ...
        public void BeginRun()
        {
            ...
            string returnstr = WSC.PayLYHZJ(zhubiao, zibiao, jsbh);
