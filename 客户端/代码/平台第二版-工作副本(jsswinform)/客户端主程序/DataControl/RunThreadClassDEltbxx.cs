...
namespace 客户端主程序.DataControl
{
    ...
    class RunThreadClassDEltbxx
    {
        ...
        public RunThreadClassDEltbxx(string NumberT, string idT, string spT, string slT, string jgT, string jsbhT, delegateForThread DFT)
        {
            //
            // TODO: 在此处添加构造函数逻辑
            //
        ...
        public void BeginRun()
        {
            ...
            string returnstr = WSC.DEltbxx(Number, id, sp, sl, jg, jsbh);
