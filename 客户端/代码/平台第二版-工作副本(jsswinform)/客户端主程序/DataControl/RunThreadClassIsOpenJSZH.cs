...
{
    class RunThreadClassIsOpenJSZH
    {
        //向线程传递的回调参数
        ...
        public RunThreadClassIsOpenJSZH(Hashtable PHT, delegateForThread DFT)
        {
            //
            // TODO: 在此处添加构造函数逻辑
            //
        ...
        public void BeginRun()
        {
            ...
            DataSet dstest = WSC.GetSelSHZT(InPutHT["登录邮箱"].ToString());

            //填充传入参数哈希表
            Hashtable OutPutHT = new Hashtable();
            OutPutHT["角色信息"] = dstest;
            DForThread(OutPutHT);
