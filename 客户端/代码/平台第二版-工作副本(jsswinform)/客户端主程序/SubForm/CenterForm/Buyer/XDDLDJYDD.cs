...
{
    public partial class XDDLDJYDD : UserControl
    {
        public XDDLDJYDD()
        {
            InitializeComponent();
        ...
        private void ShowThreadResult_save_Invoke(Hashtable returnHT)
        {
            ...
            switch (zt)
            {
                case "ok":
                    ...
                    //重置本表单，或转向其他页面
                    XDDLDJYDD UC = new XDDLDJYDD();//这句话是关键，若实例化本身的类，则是重置表单，若实例化其他的类，则是跳转
                    reset(UC);
        ...
        /// </summary>
        /// <param name="UC"></param>
        private void reset(XDDLDJYDD UC)
        {
        ...
        private void basicButton2_Click_1(object sender, EventArgs e)
        {
            ArrayList Almsg3 = new ArrayList();
            Almsg3.Add("");
            Almsg3.Add(客户端主程序.DataControl.PublicDS.PublisDsUser.Tables[0].Rows[0]["卖家角色编号"].ToString());
            FormAlertMessage FRSE3 = new FormAlertMessage("仅确定", "错误", "提示", Almsg3);
            FRSE3.ShowDialog();
        }
