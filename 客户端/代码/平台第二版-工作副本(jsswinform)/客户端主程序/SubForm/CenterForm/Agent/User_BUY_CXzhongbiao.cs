...
{
    public partial class User_BUY_CXzhongbiao : UserControl
    {
        /// <summary>
        /// 查询条件
        /// </summary>
        ...
        private void setDefaultSearch()
        {
            ...
            ht_where["search_tbname"] = "  ( select BUYDLYX,MJYHM,'合同编号'=Number ,'预订单号'=BUYYDDBH,'商品编号'=SPBH,'商品名称'=SPMC,'型号规格'=GGXH,'计价单位'=JJDW,'供货周期'=HTQX, '中标价格'=SELTBJG,'买入价格'=BUYMRJG,'预订量'=ZBSL,'中标预订单金额'=ZBZJE,'订金'=BUYYDDYSDJJE,'下达时间'=BUYXDYDDSJ,'中标时间'=ZBSJ from ZZ_ZBDBXXB where BUYJJRDLYX = '" + BUYjsbh + "' and ZBDBZT='中标' ) as tab  ";  //检索的表(必须设置)
