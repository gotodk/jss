...
{
    public partial class CXYHLBCK : UserControl
    {
        /// <summary>
        /// 查询条件
        /// </summary>
        ...
        public CXYHLBCK()
        {
            ...
            //处理下拉框间距
            this.comboBox1.DrawItem += new System.Windows.Forms.DrawItemEventHandler(this.CB_DrawItem);
            this.comboBox2.DrawItem += new System.Windows.Forms.DrawItemEventHandler(this.CB_DrawItem);
        }
        //处理下拉框间距
