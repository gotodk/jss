...
namespace Com.Seezt.Skins
{
    ...
    public partial class BasicComboBox : UserControl
    {
        ...
        public BasicComboBox()
        {
            ...
            img = ResClass.GetResObj("combobox_buttonNormalDraw");
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            {
                g.DrawString(Texts, new Font("宋体", 9F), this.Enabled?Brushes.Black:Brushes.Gray, new Point(2, 4));
            }
        }
        ...
        protected override void OnMouseEnter(EventArgs e)
        {
            if (!showed)
            {
                ...
                img = ResClass.GetResObj("combobox_buttonHighlightDraw");
                this.Invalidate();
            }
        }
        ...
        protected override void OnMouseDown(MouseEventArgs e)
        {
            ...
            img = ResClass.GetResObj("combobox_buttonPushedDraw");
            if (Items != null)
            {
                p = new Panel();
                p.Left = 2;
    ...
    public class ComboBoxItem : UserControl
    {
        ...
        public ComboBoxItem()
        {
            ...
            bmp1 = ResClass.GetResObj("mune_select_bkg");
        }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            g1.DrawString(Texts, new Font("宋体", 9F), Brushes.DodgerBlue, new Point(0, 3));
        }
        ...
        protected override void OnMouseEnter(EventArgs e)
        {
            ...
            g1.DrawString(Texts, new Font("宋体", 9F), Brushes.White, new Point(0, 3));
        }
