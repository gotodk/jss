...
{
    public static class PublicDS
    {
        /// <summary>
        /// 记录账户基本信息，全局静态
        /// </summary>
        public static DataSet PublisDsUser;

        /// <summary>
        /// 记录提前获取的一些数据或参数
        /// </summary>
        public static DataSet PublisDsData;

        /// <summary>
        /// 记录提前获取的一些数据或参数
        /// </summary>
        public static DataSet PublisDsSPFL;

        /// <summary>
        /// 记录提前获取的自选商品临时表
        /// </summary>
        public static DataSet PublisDsZXSP;

        /// <summary>
        /// 服务器当前时间。不精确，有一定延迟。
        /// </summary>
        public static DateTime PublisTimeServer = DateTime.Now;
    }
    ...
    public class XMLConfig
    {
        ...
        static string filaname = System.AppDomain.CurrentDomain.SetupInformation.ApplicationBase + @"\Config.xml";
        static XMLConfig()
        {
            DSConfig_ENC = new DataSet();
            DSConfig_NoENC = new DataSet();
            filaname = System.AppDomain.CurrentDomain.SetupInformation.ApplicationBase + @"\Config.xml";
        }
