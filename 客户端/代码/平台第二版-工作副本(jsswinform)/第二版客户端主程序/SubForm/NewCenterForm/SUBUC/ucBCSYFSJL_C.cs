...
{
    public partial class ucBCSYFSJL_C : UserControl
    {
         /// <summary>
        /// 查询条件
        /// </summary>
        ...
        private void ucBCSYFSJL_C_Load(object sender, EventArgs e)
        {
            //处理下拉框间距
        ...
        private void setDefaultSearch()
        {
            ...
            //ht_where["search_str_where"] = " 1=1 and a.sjlx='预' and isnull(b.dymkbh,'')='8' and a.dlyx='" + dlyx + "' ";  //检索条件(必须设置)
