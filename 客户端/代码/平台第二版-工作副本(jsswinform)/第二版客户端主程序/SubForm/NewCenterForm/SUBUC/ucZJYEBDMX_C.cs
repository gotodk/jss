...
{
    public partial class ucZJYEBDMX_C : UserControl
    {
        /// <summary>
        /// 查询条件
        /// </summary>
        ...
        private void ucZJYEBDMX_C_Load(object sender, EventArgs e)
        {
            //处理下拉框间距
        ...
        private void setDefaultSearch()
        {
           ...
           // ht_where["serach_Row_str"] = " a.XM as 项目,a.XZ as 性质,a.ZY as 摘要,case when  a.YSLX in ('增加','解冻') then '+'+convert(varchar(20),convert(decimal(18,2),a.JE)) else '-'+convert(varchar(20),convert(decimal(18,2),a.JE)) end as 金额,a.LSCSSJ as 时间 "; //检索字段(必须设置)
           ...
           // ht_where["search_str_where"] = " 1=1 and a.sjlx='实' and a.dlyx='"+dlyx+"' ";  //检索条件(必须设置)
           //// ht_where["search_str_where"] = " 1=1 and b.sjlx='实'";
        ...
        private void btnExport_Click(object sender, EventArgs e)
        {
            ...
            //string sql = "select a.LSCSSJ as 时间,a.ZY as 摘要, a.XM as 项目,a.XZ as 性质,case when  a.YSLX in ('增加','解冻') then '+'+convert(varchar(20),convert(decimal(18,2),a.JE)) else '-'+convert(varchar(20),convert(decimal(18,2),a.JE)) end as 金额 from AAA_ZKLSMXB as a left join AAA_moneyDZB as b on a.xm=b.xm and a.xz=b.xz  and a.sjlx=b.sjlx  where " + ht_where["search_str_where"].ToString();
            //sql = sql + " order by a.LSCSSJ DESC,a.number desc";
            //cMyXls1.BeginRunFrom_ht_where(sql, HideColumns);

            
            Hashtable ht = new Hashtable();
            ht["filename"] = "资金余额变动明细";
            ht["webmethod"] = "资金转账C区导出";
            ht["tiaojian"] = (Hashtable)ht_where["tiaojian"];
            //string[] HideColumns = new string[] { "金额" };
