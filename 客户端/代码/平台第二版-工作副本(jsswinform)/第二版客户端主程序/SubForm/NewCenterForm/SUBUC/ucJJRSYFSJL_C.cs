...
{
    public partial class ucJJRSYFSJL_C : UserControl
    {
        /// <summary>
        /// 查询条件
        /// </summary>
        ...
        public ucJJRSYFSJL_C()
        {
            InitializeComponent();
            //初始化分页回调(带分页的页面，先把这个放上)
            ucPager1.DFT = new delegateForThread(STR_BeginBind);
        }
        private void ucJJRSYFSJL_C_Load(object sender, EventArgs e)
        {
            //处理下拉框间距
        ...
        private void setDefaultSearch()
        {
            ...
            //ht_where["search_str_where"] = " 1=1 and a.sjlx='预' and isnull(b.dymkbh,'')='9' and a.dlyx='" + dlyx + "' ";  //检索条件(必须设置)
