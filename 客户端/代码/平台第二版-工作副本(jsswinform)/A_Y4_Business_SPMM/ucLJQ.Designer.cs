namespace 客户端主程序.SubForm.NewCenterForm.SUBUC.SPMM
{
    partial class ucLJQ
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.冷静期结束时间 = new System.Windows.Forms.DataGridViewTextBoxColumn();
            ...
            // 冷静期结束时间
            // 
            this.冷静期结束时间.AutoSizeMode = System.Windows.Forms.DataGridViewAutoSizeColumnMode.AllCells;
            this.冷静期结束时间.DataPropertyName = "冷静期结束时间";
            this.冷静期结束时间.HeaderText = "冷静期结束时间";
            this.冷静期结束时间.Name = "冷静期结束时间";
            this.冷静期结束时间.ReadOnly = true;
            this.冷静期结束时间.Width = 119;
            // 
            // 下单时间
            // 
            ...
            this.Load += new System.EventHandler(this.ucLJQ_Load);
        ...
        private System.Windows.Forms.DataGridViewTextBoxColumn 冷静期结束时间;
