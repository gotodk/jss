...
namespace 客户端主程序.SubForm
{
    public partial class UCCityList : UserControl
    {
        ...
        private void UCCityList_EnabledChanged(object sender, EventArgs e)
        {
            if (CityList_Promary.Enabled == false)
            {
                CityList_Promary.ForeColor = Color.DarkGray;
            }
            else
            {
                CityList_Promary.ForeColor = Color.Black;
            }
        }

        private void ZZ_CityList_City_EnabledChanged(object sender, EventArgs e)
        {
            if (ZZ_CityList_City.Enabled == false)
            {
                ZZ_CityList_City.ForeColor = Color.DarkGray;
            }
            else
            {
                ZZ_CityList_City.ForeColor = Color.Black;
            }
        }

        private void ZZ_CityList_qu_EnabledChanged(object sender, EventArgs e)
        {
            if (ZZ_CityList_qu.Enabled == false)
            {
                ZZ_CityList_qu.ForeColor = Color.DarkGray;
            }
            else
            {
                ZZ_CityList_qu.ForeColor = Color.Black;
            }
        }
